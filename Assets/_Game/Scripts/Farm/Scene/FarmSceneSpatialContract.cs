...
namespace CindarsHope.Farm.Scene
{
    ...
    public static class FarmSceneSpatialContract
    {
        ...
        public static IReadOnlyList<Vector2> RiverBelowBridgeCollisionPath { get; } = new[]
        {
            ...
            // Contact v16: visible west-bank rock at gameplay_d/confluence_1_0125.
            // Pixel x255..258 at28.2353px/u maps to x26.70..26.80 near y-4.45.
            // Physical support only; the water/art footprint above remains unchanged.
            new Vector2(26.70f, -4.45f),
            new Vector2(27.45f, -3.6f), new Vector2(27.05f, -1.9f), new Vector2(26.1f, 0.2f)
        };

        public const float DockDeckWestX = 11.91f;
        ...
        public static IReadOnlyList<Vector2> LakeCollisionPath { get; } = new[]
        {
            ...
            new Vector2(11.91f, -8.4875f), new Vector2(DockDeckWestX, DockDeckSouthY),
            new Vector2(DockDeckEastX, DockDeckSouthY), new Vector2(15.21f, -7.355f),
