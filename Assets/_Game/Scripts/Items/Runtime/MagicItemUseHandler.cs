...
namespace CindarsHope.Items.Runtime
{
    ...
    public sealed class MagicItemUseHandler : ItemUseHandler
    {
        ...
        public override bool TryUseItem(string itemId, int amount, GameObject user)
        {
            ...
            if (!result.Consumed)
            {
                Debug.Log($"CombatLog: MagicUseRefused. Item={itemId}, Reason={result.Reason}.", this);
                return false;
            }
        ...
        private bool TryRequestMirrorReturn()
        {
            ...
            if (runManager == null)
            {
                Debug.Log("CombatLog: MagicUseRefused. Item=mirror_of_return, Reason=no_active_cave_run.", this);
                return false;
            }
            ...
            Debug.Log($"CombatLog: MirrorReturnRequested. RunSeed={runSeed}, Level={level}.", this);
            return true;
        }
    }
}
