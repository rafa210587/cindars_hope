...
namespace CindarsHope.Enemy
{
    ...
    public sealed class EnemyVolatileExplosionRunner : MonoBehaviour
    {
        ...
        private void Detonate()
        {
            ...
            if (dist > BlastRadius)
            {
                CindarsHope.DebugTools.CombatLog.Log($"CombatLog: EliteVolatileBlastDodged. EnemyId={_sourceEnemyId}, Distance={dist:F2}, Radius={BlastRadius:F2}.");
                return;
            }
            ...
            CindarsHope.DebugTools.CombatLog.Log($"CombatLog: EliteVolatileBlastHit. EnemyId={_sourceEnemyId}, Damage={applied}.");
        }
    }
}
