    ...
    public static class CreateEnemySpawnEcologyData
    {
        ...
        public static List<ProfileDefinition> BuildProfileDefinitions()
        {
            ...
            return new List<ProfileDefinition>
            {
                ...
                P("enemy_frost_gnawer",26,40,"ice","beast",EnemySizeClass.Small,2,"lock_after_gate_15"),
                P("enemy_duergar_frostdelver",26,40,"ice","duergar",EnemySizeClass.Medium,2,"lock_after_gate_15"),
                P("enemy_duergar_shieldbreaker",26,40,"ice","duergar",EnemySizeClass.Medium,1,"lock_after_gate_15"),
                P("enemy_icebound_sentinel",26,40,"ice","ice_cult",EnemySizeClass.Large,1,"lock_after_gate_15"),
                P("enemy_glassbone",26,40,"ice","undead_stronger",EnemySizeClass.Medium,1,"lock_after_gate_15"),
                P("enemy_cold_cult_acolyte",26,40,"ice","ice_cult",EnemySizeClass.Medium,1,"lock_after_gate_15"),
                P("enemy_crystal_leaper",26,40,"ice","beast",EnemySizeClass.Medium,1,"lock_after_gate_15"),
                P("enemy_frost_wailer",26,40,"ice","undead_stronger",EnemySizeClass.Medium,1,"lock_after_gate_15"),
                P("enemy_ember_tick",41,55,"fire","elemental_fire",EnemySizeClass.Tiny,5,"lock_after_gate_30"),
                P("enemy_ash_crawler",41,55,"fire","beast",EnemySizeClass.Medium,1,"lock_after_gate_30"),
                P("enemy_orc_kaand_berserker",41,55,"fire","orc_kaand",EnemySizeClass.Medium,1,"lock_after_gate_30"),
                P("enemy_orc_kaand_ashcaller",41,55,"fire","orc_kaand",EnemySizeClass.Medium,1,"lock_after_gate_30"),
                P("enemy_lava_bulwark",41,55,"fire","elemental_fire",EnemySizeClass.Huge,1,"lock_after_gate_30"),
                P("enemy_cinder_spitter",41,55,"fire","elemental_fire",EnemySizeClass.Small,2,"lock_after_gate_30"),
                P("enemy_scorched_cultist",41,55,"fire","furnace_construct",EnemySizeClass.Medium,1,"lock_after_gate_30"),
                P("enemy_furnace_warden",41,55,"fire","furnace_construct",EnemySizeClass.Large,1,"lock_after_gate_30"),
                P("enemy_rune_shard",56,70,"ruins","stronger_construct",EnemySizeClass.Small,4,"lock_after_gate_45"),
                P("enemy_clockwork_guard",56,70,"ruins","stronger_construct",EnemySizeClass.Medium,1,"lock_after_gate_45"),
                P("enemy_gnome_gem_madcap",56,70,"ruins","gnome_ruins",EnemySizeClass.Small,1,"lock_after_gate_45"),
                P("enemy_gnomorin_rune_tinker",56,70,"ruins","gnome_ruins",EnemySizeClass.Small,2,"lock_after_gate_45"),
                P("enemy_sealed_knight",56,70,"ruins","oathless_undead",EnemySizeClass.Large,1,"lock_after_gate_45"),
                P("enemy_mirror_adept",56,70,"ruins","gnome_ruins",EnemySizeClass.Medium,1,"lock_after_gate_45"),
                P("enemy_puzzle_golem",56,70,"ruins","stronger_construct",EnemySizeClass.Huge,1,"lock_after_gate_45"),
                P("enemy_oathless_shade",56,70,"ruins","oathless_undead",EnemySizeClass.Medium,1,"lock_after_gate_45"),
                // Band 6 – Deep (71-85) – drow/abyssal (lock_after_gate_60) + ninrorin (lock_after_gate_75)
                P("enemy_drow_shadowblade",71,85,"deep","drow",EnemySizeClass.Medium,2,"lock_after_gate_60"),
                P("enemy_drow_arcane_adept",71,85,"deep","drow",EnemySizeClass.Small,1,"lock_after_gate_60"),
                P("enemy_drow_shadow_warden",71,85,"deep","drow",EnemySizeClass.Large,1,"lock_after_gate_60"),
                P("enemy_void_tick",71,85,"deep","abyssal",EnemySizeClass.Tiny,4,"lock_after_gate_60"),
                P("enemy_abyssal_riftstalker",71,85,"deep","abyssal",EnemySizeClass.Medium,2,"lock_after_gate_60"),
                P("enemy_shadow_sentinel",71,85,"deep","abyssal",EnemySizeClass.Large,1,"lock_after_gate_60"),
                P("enemy_void_spitter",71,85,"deep","abyssal",EnemySizeClass.Small,2,"lock_after_gate_60"),
                P("enemy_abyssal_void_reaver",71,85,"deep","abyssal",EnemySizeClass.Medium,1,"lock_after_gate_60"),
                P("enemy_ninrorin_phasewalker",76,85,"deep","ninrorin",EnemySizeClass.Medium,1,"lock_after_gate_75"),
                P("enemy_ninrorin_echo_shade",76,85,"deep","ninrorin",EnemySizeClass.Small,2,"lock_after_gate_75"),
                // Band 7 – Void (86-99) – ninrorin/corrupted/draconic (lock_after_gate_75) + blackstone (lock_after_gate_90)
                P("enemy_ninrorin_void_knight",86,99,"void","ninrorin",EnemySizeClass.Large,1,"lock_after_gate_75"),
                P("enemy_ninrorin_void_acolyte",86,99,"void","ninrorin",EnemySizeClass.Medium,1,"lock_after_gate_75"),
                P("enemy_corrupted_draconic_spawn",86,99,"void","corrupted",EnemySizeClass.Large,1,"lock_after_gate_75"),
                P("enemy_corrupted_lich_shard",86,99,"void","corrupted",EnemySizeClass.Small,3,"lock_after_gate_75"),
                P("enemy_draconic_void_wyrm",86,99,"void","draconic",EnemySizeClass.Large,1,"lock_after_gate_75"),
                P("enemy_draconic_elder_kin",86,99,"void","draconic",EnemySizeClass.Huge,1,"lock_after_gate_75"),
                P("enemy_corrupted_bone_knight",86,99,"void","corrupted",EnemySizeClass.Large,1,"lock_after_gate_75"),
                P("enemy_ninrorin_void_sentinel",86,99,"void","ninrorin",EnemySizeClass.Large,1,"lock_after_gate_75"),
                P("enemy_blackstone_wyvern",91,99,"void","blackstone_wyvern",EnemySizeClass.Huge,1,"lock_after_gate_90"),
                P("enemy_draconic_ashspitter",91,99,"void","draconic",EnemySizeClass.Small,2,"lock_after_gate_90"),
            }.Select(p =>
            {
        ...
        public static List<PackDefinition> BuildPackDefinitions()
        {
            return new List<PackDefinition>
            {
                ...
                // Band 6 – Deep (71-85)
                Pack("pack_drow_court",71,85,"deep",12,E("enemy_drow_shadowblade",2,4),E("enemy_drow_arcane_adept",1,2),E("enemy_drow_shadow_warden",0,1,false)),
                Pack("pack_abyssal_void_rift",71,85,"deep",12,E("enemy_void_tick",3,6),E("enemy_abyssal_riftstalker",1,2),E("enemy_void_spitter",1,2,false)),
                Pack("pack_ninrorin_broken_echoes",76,85,"deep",8,E("enemy_ninrorin_phasewalker",1,2),E("enemy_ninrorin_echo_shade",1,3)),
                // Band 7 – Void (86-99)
                Pack("pack_corrupted_draconic_nest",86,99,"void",10,E("enemy_corrupted_draconic_spawn",1,2),E("enemy_corrupted_lich_shard",2,4),E("enemy_draconic_void_wyrm",0,1,false)),
                Pack("pack_void_deep_horde",86,99,"void",8,E("enemy_ninrorin_void_knight",1,2),E("enemy_ninrorin_void_acolyte",1,2),E("enemy_draconic_elder_kin",0,1,false)),
                Pack("pack_blackstone_wyvern_arena",91,99,"void",6,E("enemy_blackstone_wyvern",1,1),E("enemy_ninrorin_void_sentinel",0,1,false)),
            };
        }
        ...
        public static List<LockDefinition> BuildLockDefinitions()
        {
            return new List<LockDefinition>
            {
                ...
                new LockDefinition("lock_after_gate_60", false, "boss_gate_level_60", 61, new[] { "drow", "abyssal", "void" }, new[] { "pack_drow_court", "pack_abyssal_void_rift" }),
                new LockDefinition("lock_after_gate_75", false, "boss_gate_level_75", 76, new[] { "ninrorin", "corrupted", "draconic" }, new[] { "pack_ninrorin_broken_echoes", "pack_corrupted_draconic_nest", "pack_void_deep_horde" }),
        ...
        private static List<ProfileDefinition> BuildProfileDefinitionsNoPacks()
        {
            return new List<ProfileDefinition>
            {
                ...
                P("enemy_drow_shadowblade",71,85,"deep","drow",EnemySizeClass.Medium,2),
                P("enemy_drow_arcane_adept",71,85,"deep","drow",EnemySizeClass.Small,1),
                P("enemy_drow_shadow_warden",71,85,"deep","drow",EnemySizeClass.Large,1),
                P("enemy_void_tick",71,85,"deep","abyssal",EnemySizeClass.Tiny,4),
                P("enemy_abyssal_riftstalker",71,85,"deep","abyssal",EnemySizeClass.Medium,2),
                P("enemy_shadow_sentinel",71,85,"deep","abyssal",EnemySizeClass.Large,1),
                P("enemy_void_spitter",71,85,"deep","abyssal",EnemySizeClass.Small,2),
                P("enemy_abyssal_void_reaver",71,85,"deep","abyssal",EnemySizeClass.Medium,1),
                P("enemy_ninrorin_phasewalker",76,85,"deep","ninrorin",EnemySizeClass.Medium,1),
                P("enemy_ninrorin_echo_shade",76,85,"deep","ninrorin",EnemySizeClass.Small,2),
                P("enemy_ninrorin_void_knight",86,99,"void","ninrorin",EnemySizeClass.Large,1),
                P("enemy_ninrorin_void_acolyte",86,99,"void","ninrorin",EnemySizeClass.Medium,1),
                P("enemy_corrupted_draconic_spawn",86,99,"void","corrupted",EnemySizeClass.Large,1),
                P("enemy_corrupted_lich_shard",86,99,"void","corrupted",EnemySizeClass.Small,3),
                P("enemy_draconic_void_wyrm",86,99,"void","draconic",EnemySizeClass.Large,1),
                P("enemy_draconic_elder_kin",86,99,"void","draconic",EnemySizeClass.Huge,1),
                P("enemy_corrupted_bone_knight",86,99,"void","corrupted",EnemySizeClass.Large,1),
                P("enemy_ninrorin_void_sentinel",86,99,"void","ninrorin",EnemySizeClass.Large,1),
                P("enemy_blackstone_wyvern",91,99,"void","blackstone_wyvern",EnemySizeClass.Huge,1),
                P("enemy_draconic_ashspitter",91,99,"void","draconic",EnemySizeClass.Small,2),
            };
        }
