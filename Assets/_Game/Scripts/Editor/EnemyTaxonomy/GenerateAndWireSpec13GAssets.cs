...
namespace CindarsHope.Editor.EnemyTaxonomy
{
    public static class GenerateAndWireSpec13GAssets
    {
        ...
        [MenuItem("CindarsHope/Advanced/Legacy/Generate/Enemy Runtime Data/Regenerate All Enemy Data")]
        public static void RegenerateAllEnemyData() => GenerateAndWire();

        [MenuItem("CindarsHope/Advanced/Legacy/SPEC 13/Generate And Wire SPEC 13G Assets")]
