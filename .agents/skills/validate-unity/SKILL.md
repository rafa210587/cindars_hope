---
name: validate-unity
description: "Comando de workflow do projeto (equivalente ao /validate-unity do Claude Code). Use quando a tarefa altera runtime C#, scenes, prefabs, assets ou ProjectSettings."
---
