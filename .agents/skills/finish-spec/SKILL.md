---
name: finish-spec
description: "Comando de workflow do projeto (equivalente ao /finish-spec do Claude Code). Closeout phase-aware com requisito de human test scenario. Promove a spec para `implementados/` somente quando a evidência exigida existe."
---
