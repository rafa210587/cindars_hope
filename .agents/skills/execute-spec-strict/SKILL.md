---
name: execute-spec-strict
description: "Comando de workflow do projeto (equivalente ao /execute-spec-strict do Claude Code). > **NOTA DE RECONCILIAÇÃO (2026-06-12):** a fila wave-based foi executada e movida para executadas_build_validated/. A fila ativa é .specs/a_implementar/fable/. Exemplos com paths NN_spec_* abaixo são históricos."
---
