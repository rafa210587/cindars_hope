...
description: "Comando de workflow do projeto (equivalente ao /loop-spec-batch-strict do Claude Code). Texto de referência para rodar um batch controlado de specs via `/loop`."
---
