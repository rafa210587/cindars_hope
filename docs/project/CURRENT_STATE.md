...
*Last updated: 2026-06-09 (WAVE_INTEGRATION_12 corrective pass: TownScene MVP NPC roster placement, dialogue trees, shop services, placement markers, and docs updated; both assemblies BUILD_VALIDATED; Unity batchmode blocked by already-open editor; WAVE12 human Play Mode still pending; next wave remains blocked)*
*Next update: after WAVE12 Play Mode checklist passes*
