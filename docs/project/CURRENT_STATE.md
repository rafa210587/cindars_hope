...
*Last updated: 2026-06-09 (WAVE_INTEGRATION_12C shop price fix: temporary overrides applied for stone/copper ore shop entries, shop price validator added, both assemblies BUILD_VALIDATED, WAVE12C human Play Mode still pending; next wave remains blocked)*
