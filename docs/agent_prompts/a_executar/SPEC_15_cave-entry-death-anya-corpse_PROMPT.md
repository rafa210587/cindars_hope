...
Consulte `docs/specs/a_implementar/spec_cave_entry_death_anya_corpse_recovery.md` ou `docs/specs/implementados/spec_cave_entry_death_anya_corpse_recovery.md` para detalhes completos.
