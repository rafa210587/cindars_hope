...
# SPEC 05 — World Activities: fishing, trees, pickups e loot
...
git checkout dev
git pull
git checkout -b feature/spec-05-world-activities-spawner-loot
```
...
```text
docs/specs/implementados/spec_world_002_activities_fishing_trees_pickups_loot.md
```

## Dependências diretas

Depende de 01-04. Bloqueia 06, 07 e 10.

## Objetivo desta execução

Fechar atividades do mundo com spawner persistente, spots de pesca e integração inicial com cave/resources.
...
- Spawner dinâmico persistente para world items.
- Fishing spots na FarmScene criados/instalados de forma reproduzível, não dependentes de configuração invisível.
- Cave fishing spots e loot procedural integrados ao mínimo necessário.
- ItemPickupRegistry cobre pickups dinâmicos e fixos.
- Play Mode: pickup, pesca, árvore, save/load e recarregamento.
...
- Drops/pickups persistem com IDs estáveis.
- Fishing/tree flows publicam eventos corretos.
- Spots e nodes são reproduzíveis por editor/installer.
- Sem busca global runtime.
...
```bash
git add <arquivos>
git commit -m "feat: finalizar spec 05 - world activities spawner loot"
```
