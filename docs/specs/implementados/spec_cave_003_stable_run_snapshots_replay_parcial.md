...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/VisitedLevelSnapshot.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/IVisitedLevelSnapshot.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CaveLevelRuntimeController.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/CaveSaveData.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Validation/CaveReplayValidator.cs` | Evidencia principal da capacidade. |
