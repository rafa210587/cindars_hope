# SPEC CAVE-001 - CaveScene, portal e runtime basico
...
### O que existe
CaveScene tem portal/runtime basico e base procedural em codigo.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Cave/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CaveRunManager.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Editor/SceneCreation/CreateMvpCaveScene.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scenes/CaveScene.unity` | Evidencia principal da capacidade. |
