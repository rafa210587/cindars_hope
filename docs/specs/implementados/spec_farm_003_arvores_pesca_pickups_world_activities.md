# SPEC FARM-003 - Arvores, pesca, pickups e world activities
...
### O que existe
Atividades de mundo incluem arvores, pesca, pickups persistentes e gating parcial por ferramenta.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/World/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/World/FishingSpot.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/WorldSaveData.cs` | Evidencia principal da capacidade. |
