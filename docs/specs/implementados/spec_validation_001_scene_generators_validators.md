# SPEC VALIDATION-001 - Scene generators e validators

> Status: Implementado parcial
> Camada: Validation
> Fonte historica: `docs_old/FASE8_EXECUTION_PLAN_CODEX_v1.0.md; PROJECT_LOG.md`
> Evidencia principal: `Assets/_Game/Scripts/Editor/**`
...
### O que existe
Editor scripts geram cenas MVP e validators cobrem dados/cenas/cave parcialmente.
...
### Pendente/futuro
- [ ] Play Mode e validadores futuros FASE9H-L pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Editor/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Validation/**` | Evidencia principal da capacidade. |
| Codigo | `README.md` | Evidencia principal da capacidade. |
| Codigo | `PROJECT_LOG.md` | Evidencia principal da capacidade. |
...
- `docs_old/FASE8_EXECUTION_PLAN_CODEX_v1.0.md; PROJECT_LOG.md`
