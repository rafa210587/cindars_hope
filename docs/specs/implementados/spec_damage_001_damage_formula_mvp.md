# SPEC DAMAGE-001 - Damage formula MVP

> Status: Implementado parcial
> Camada: Combat
> Fonte historica: `docs_old/FASE9E_DAMAGE_STATUS_FORMULA_SPEC_v1.0.md`
> Evidencia principal: `Assets/_Game/Scripts/Combat/DamageCalculator.cs`
...
### O que existe
DamageCalculator e DTOs de dano centralizam formula MVP.
...
### Pendente/futuro
- [ ] Status effects, elementos e resistencias completas pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Combat/DamageCalculator.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/DamageRequest.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/DamageResult.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/DamageType.cs` | Evidencia principal da capacidade. |
