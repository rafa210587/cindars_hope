# SPEC COMBAT-001 - Slime, melee, contact damage e drops

> Status: Implementado parcial
> Camada: Combat
> Fonte historica: `docs_old/FASE9B_CAVE_COMBAT_MVP_v1.0.md`
> Evidencia principal: `Assets/_Game/Scripts/Combat/PlayerAttackController.cs`
...
### O que existe
Combate MVP tem ataque melee, Slime, dano por contato, morte, drops e XP parcial.
...
### Pendente/futuro
- [ ] Armas, magia, IA avancada e balanceamento final pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Combat/PlayerAttackController.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/EnemyHealth.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/EnemyChaseController.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/EnemyContactDamage.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Combat/EnemyDropSpawner.cs` | Evidencia principal da capacidade. |
