# SPEC ECONOMY-001 - Compra, venda, gold e sellables

> Status: Implementado parcial
> Camada: Economy
> Fonte historica: `docs_old/FASE9A_HANDOFF_FARM_TOWN_SAVE_v1.0.md`
> Evidencia principal: `Assets/_Game/Scripts/Economy/**`
...
### O que existe
Compra/venda basica e gold conectam Farm, Town e Inventory.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Economy/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Town/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Core/Events/EconomyTransactionCompletedEvent.cs` | Evidencia principal da capacidade. |
