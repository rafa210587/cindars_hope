...
### O que existe
Crafting MVP valida ingredientes e cria resultados, incluindo madeira processada.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Craft/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Data/Recipes/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Data/Registries/RecipeDatabase.asset` | Evidencia principal da capacidade. |
