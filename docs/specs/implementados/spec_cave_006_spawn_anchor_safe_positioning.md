...
> Camada: Cave
> Fonte histórica: `docs_old/audits/FIX_CAVE_SPAWN_ANCHOR_SAFE_POSITIONING.md`
> Refinamento relacionado: `docs/refinements/implementados/ref_fix_cave_spawn_anchor_safe_positioning.md`
> Evidência principal: `Assets/_Game/Scripts/Cave/Runtime/CaveLevelRuntimeController.cs`
...
|---|---|---|
| Código | `Assets/_Game/Scripts/Cave/Runtime/CaveLevelRuntimeController.cs` | Evidência principal. |
| Histórico | `docs_old/audits/FIX_CAVE_SPAWN_ANCHOR_SAFE_POSITIONING.md` | Fonte histórica preservada. |
| Refinamento | `docs/refinements/implementados/ref_fix_cave_spawn_anchor_safe_positioning.md` | Refinamento ativo relacionado. |
