# SPEC CORE-002 - Bootstrap, managers e runtime references

> Status: Implementado parcial
> Camada: Core
> Fonte historica: `docs_old/ARCH_fase4_v2.2.md; docs_old/IMPLEMENTATION_STATUS.md`
> Evidencia principal: `Assets/_Game/Scripts/Core/Bootstrap/GameBootstrap.cs`
...
### O que existe
GameBootstrap e installers mantem managers persistentes e rebind de referencias por cena.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Core/Bootstrap/GameBootstrap.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/SaveManager.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/**/**RuntimeReferenceInstaller.cs` | Evidencia principal da capacidade. |
