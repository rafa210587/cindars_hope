...
> Camada: Cave
> Fonte historica: `docs_old/FASE9G_CAVE_BESTIARY_FACTION_LOCKS_PORTAL_ECOLOGY_SPEC_v1.0.md; spec/implementado/SPEC_CAVE_BOSS_GATES_CHECKPOINTS_CONFINEMENT_PR193_202.md`
> Evidencia principal: `Assets/_Game/Scripts/Cave/Data/CaveBossGateDataSO.cs`
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Cave/Data/CaveBossGateDataSO.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Data/CaveBossGateRegistrySO.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CaveBossSpawner.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CaveBossDefeatMonitor.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CaveCheckpointSelectionUI.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Cave/Runtime/CavePlayerPathConfinement.cs` | Evidencia principal da capacidade. |
...
- `docs_old/FASE9G_CAVE_BESTIARY_FACTION_LOCKS_PORTAL_ECOLOGY_SPEC_v1.0.md; spec/implementado/SPEC_CAVE_BOSS_GATES_CHECKPOINTS_CONFINEMENT_PR193_202.md`
