# SPEC SAVE-001 - JSON save/load cross-scene

> Status: Implementado parcial
> Camada: Save
> Fonte historica: `docs_old/CORE_CONTRACTS_EVENTS_SAVE_IDS_v1.0.md; docs_old/IMPLEMENTATION_STATUS.md`
> Evidencia principal: `Assets/_Game/Scripts/Save/SaveManager.cs`
...
### O que existe
Save/load usa JSON em Application.persistentDataPath/saves/slot_1.json, schema version, cena atual e DTOs simples para player/inventory/equipment/hotbar/progression/farm/world/cave.
...
### Pendente/futuro
- [ ] Migration robusta e validacao Play Mode completa pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Save/SaveManager.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/GameSaveData.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/*SaveData.cs` | Evidencia principal da capacidade. |
...
- `docs_old/CORE_CONTRACTS_EVENTS_SAVE_IDS_v1.0.md; docs_old/IMPLEMENTATION_STATUS.md`
