# SPEC TOWN-001 - TownScene, portais, NPC Pip e comercio

> Status: Implementado parcial
> Camada: Town
> Fonte historica: `docs_old/FASE9A_HANDOFF_FARM_TOWN_SAVE_v1.0.md; docs/refinements/implementados/ref_town_pr053_063.md`
> Evidencia principal: `Assets/_Game/Scripts/SceneManagement/**`
...
### O que existe
TownScene MVP tem portais Farm/Town, NPC Pip placeholder e comercio basico.
...
### Pendente/futuro
- [ ] Dialogo, agenda NPC e loja final pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/SceneManagement/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Town/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Editor/SceneCreation/CreateMvpTownScene.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scenes/TownScene.unity` | Evidencia principal da capacidade. |
...
- `docs_old/FASE9A_HANDOFF_FARM_TOWN_SAVE_v1.0.md; docs/refinements/implementados/ref_town_pr053_063.md`
