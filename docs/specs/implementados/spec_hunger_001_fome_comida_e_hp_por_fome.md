# SPEC HUNGER-001 - Fome, comida e HP por fome

> Status: Implementado parcial
> Camada: Player
> Fonte historica: `docs_old/FASE8_EXECUTION_PLAN_CODEX_v1.0.md`
> Evidencia principal: `Assets/_Game/Scripts/Player/HungerManager.cs`
...
### O que existe
Fome MVP diminui por acoes/dia e comida restaura fome; HP por fome existe em nivel parcial/debug.
...
### Pendente/futuro
- [ ] Balanceamento final, UX e interacao com stamina/status pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Player/HungerManager.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Inventory/FoodConsumer.cs` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Core/Events/HungerChangedEvent.cs` | Evidencia principal da capacidade. |
