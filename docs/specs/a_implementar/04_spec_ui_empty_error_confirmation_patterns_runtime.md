...
```bash
rg -n "EmptyState|BlockedState|Confirmation|PendingConfirmation|NoItems|NoRecipes|MissingGold|MissingRequirement|FeatureFuture|FocusOrder|Cancel|Confirm" Assets/_Game/Scripts docs/design docs/specs
