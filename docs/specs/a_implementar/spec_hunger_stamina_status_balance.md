# SPEC - Hunger, stamina, status e balance
...
> Escopo: Integrar fome com stamina, buffs/debuffs, status e balanceamento.
...
## Objetivo
Integrar fome com stamina, buffs/debuffs, status e balanceamento.
...
## Arquitetura
Player stats, hunger, stamina, status, combat e UI. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Player stats, hunger, stamina, status, combat e UI.
...
## Riscos de regressao
Combat/tools podem consumir recursos com regras divergentes.
