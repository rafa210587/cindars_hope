...
> Escopo: Substituir punch MVP por armas, magias, skill actions, mana/stamina e active slots.
...
## Objetivo
Substituir punch MVP por armas, magias, skill actions, mana/stamina e active slots.
...
## Arquitetura
Combat player, weapons, magic, skills, hotbar e save. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Combat player, weapons, magic, skills, hotbar e save.
...
## Riscos de regressao
Enemy AI e skill trees podem acoplar em comandos provisorios.
