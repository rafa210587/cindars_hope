...
```bash
rg -n "Crafting|Recipe|Craftable|MissingMaterials|MissingStation|LockedBySkill|LockedByQuest|UnknownHidden|ProcessingActive|ReadyToCollect|CraftMany" Assets/_Game/Scripts docs/design docs/specs
