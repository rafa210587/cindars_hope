...
```bash
rg -n "FarmOrder|Encomenda|OrderBoard|DeliverItem|ShipItem|HarvestCrop|ProcessItem|Deadline|RepeatPolicy|QualityAcceptance" Assets/_Game/Scripts docs/design docs/specs
