...
```bash
rg -n "Shop|Buy|Sell|Stock|LimitedStock|UniqueStock|Price|Gold|Sellable|CanSell|ShopInventory|PlayerInventory|EmptyState" Assets/_Game/Scripts docs/design docs/specs
