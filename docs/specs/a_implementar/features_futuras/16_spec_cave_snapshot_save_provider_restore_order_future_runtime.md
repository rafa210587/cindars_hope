...
```bash
rg -n "CaveSaveSectionProvider|CaveSaveData|VisitedLevelSnapshot|CaveSnapshotNormalizer|RestoreOrder|PreserveIfSceneMissing|EnemySpawnPlan" Assets/_Game/Scripts docs/design docs/specs
