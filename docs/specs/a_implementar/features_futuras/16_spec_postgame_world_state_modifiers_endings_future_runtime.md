...
```bash
rg -n "PostGameWorldState|EndingModifier|Protect|Seal|Use|ManaPostGame|FontePostGame|CavePostGame|BromecianTech|AppliedOnce" Assets/_Game/Scripts docs/design docs/specs
