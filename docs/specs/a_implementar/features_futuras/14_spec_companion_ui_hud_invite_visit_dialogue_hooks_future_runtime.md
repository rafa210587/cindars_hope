...
```powershell
Select-String -Path .\Assets\_Game\Scripts\*,.\docs\design\*,.\docs\specs\* -Pattern "CompanionInvite|CompanionHud|CompanionVisit|CompanionDialogue|AvailabilityReason|KnowledgeHint|Romance|Spouse|PetHUD|Breath|Folego" -Recurse
```
