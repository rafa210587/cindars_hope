...
```bash
rg -n "ManaLunar|Alihana|Senya|Nyx|ManaCorruption|BlackStone|PedraNegra|ManaBloom|LunarForecast|TripleAlignment" Assets/_Game/Scripts docs/design docs/specs
