...
```bash
rg -n "AutomationStorage|InputReservation|OutputCommit|StorageTransaction|IdempotencyKey|AutoSell|Rollback|InputChest|OutputChest" Assets/_Game/Scripts docs/design docs/specs
