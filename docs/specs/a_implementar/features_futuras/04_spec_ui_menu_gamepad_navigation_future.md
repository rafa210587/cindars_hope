...
```bash
rg -n "Gamepad|Navigation|FocusOrder|UIScreenConfig|UIFocusProfile|InputAction|ProjectSettings|Confirm|Cancel|Back|SelectedInventorySlot|SelectedQuestId" Assets/_Game/Scripts docs/design docs/specs
