...
```bash
rg -n "BestiaryKnowledgeSection|EnemyKnowledgeKey|EnemyKnowledgeState|KnowledgeConfidence|KnowledgeRecord|KnowledgeCategory|KnowledgeMerge" Assets/_Game/Scripts docs/design docs/specs
