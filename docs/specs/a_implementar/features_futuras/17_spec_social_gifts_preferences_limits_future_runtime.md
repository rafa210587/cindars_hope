...
```bash
rg -n "GiftPreference|GiftAttempt|LovedGift|ForbiddenGift|RomanticGift|GiftLimit|SocialGiftTag|PreferenceDiscovery" Assets/_Game/Scripts docs/design docs/specs
