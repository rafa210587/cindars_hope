...
docs/specs/SPEC_EXECUTION_ORDER.md ; docs/project/CURRENT_STATE.md ; PROJECT_LOG.md
docs/specs/implementados/** ; docs/refinements/implementados/**
...
Select-String -Path .\Assets\_Game\Scripts\**\*.cs,.\docs\design\**\*.md,.\docs\specs\**\*.md -Pattern "CompanionEligibility|CompanionState|CompanionSave|CanBeFarmCompanion|CanBeCaveCompanion|CanBeRomanceCompanion|Spouse|Breath|Folego" -Recurse
