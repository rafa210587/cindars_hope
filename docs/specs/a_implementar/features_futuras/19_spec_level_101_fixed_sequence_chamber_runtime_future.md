...
```bash
rg -n "Level101Sequence|Level101Chamber|Level101LoreBeat|PortalReturn|Boss101|SilentMemoryCorridor|CorruptedLivingWater" Assets/_Game/Scripts docs/design docs/specs
