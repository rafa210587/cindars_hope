...
```bash
rg -n "BestiaryCombatOverlay|TargetKnowledge|KnownWeakness|KnownResistance|KnowledgeOverlay|CombatKnowledgeSpoiler|TargetInfo" Assets/_Game/Scripts docs/design docs/specs
