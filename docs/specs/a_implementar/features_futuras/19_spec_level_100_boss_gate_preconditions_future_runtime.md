...
```bash
rg -n "Level100Gate|Gate100|BossGate|Level101Unlocked|UniqueReward|PreviousBossGates|FragmentoEsperanca|GateHint" Assets/_Game/Scripts docs/design docs/specs
