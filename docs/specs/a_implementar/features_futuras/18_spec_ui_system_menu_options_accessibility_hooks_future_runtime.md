...
```bash
rg -n "SystemMenu|OptionsMenu|Accessibility|ReduceStrongFlashes|UiVolume|DestructiveAction|GamepadFuture|NavigationCapability" Assets/_Game/Scripts docs/design docs/specs
