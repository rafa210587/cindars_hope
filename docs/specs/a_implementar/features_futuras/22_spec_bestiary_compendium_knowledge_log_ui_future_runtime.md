...
```bash
rg -n "BestiaryCompendium|KnowledgeLog|BestiaryCard|RevealSection|KnowledgeConfidence|UnknownProjection|BestiarySpoiler" Assets/_Game/Scripts docs/design docs/specs
