...
```bash
rg -n "AdvancedCompanion|PartySize|CompanionEquipment|CompanionSkillTree|TacticalCommand|Permadeath|AISquad|HostileCity" Assets/_Game/Scripts docs/design docs/specs
