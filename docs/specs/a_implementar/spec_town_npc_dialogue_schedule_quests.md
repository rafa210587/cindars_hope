...
> Escopo: Evoluir Town/Pip para NPCs com dialogo, agenda, lojas e quests leves.
...
## Objetivo
Evoluir Town/Pip para NPCs com dialogo, agenda, lojas e quests leves.
...
## Arquitetura
Town, NPC, dialogue, shops, quests e save. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Town, NPC, dialogue, shops, quests e save.
...
## Riscos de regressao
Fonte de Anya e lojas podem nascer sem contratos de NPC/quest.
