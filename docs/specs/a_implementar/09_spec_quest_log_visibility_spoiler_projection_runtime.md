...
```bash
rg -n "QuestLog|QuestVisibility|VisibilityPolicy|QuestDetail|QuestProjection|SpoilerTier|KnownObjective|KnownHint|WaitingReason|Track" Assets/_Game/Scripts docs/design docs/specs
