...
```bash
rg -n "FonteAnya|FonteState|LivingWater|AguaViva|Respec|Purification|FonteFunction|FragmentWater|FragmentMemory|FragmentLife|FragmentHope" Assets/_Game/Scripts docs/design docs/specs
