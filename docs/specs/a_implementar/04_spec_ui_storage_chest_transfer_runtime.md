...
```bash
rg -n "Storage|Chest|Container|Inventory|Transfer|MoveStack|SplitStack|Sort|StorageScreen|ContainerInventory" Assets/_Game/Scripts docs/design docs/specs
