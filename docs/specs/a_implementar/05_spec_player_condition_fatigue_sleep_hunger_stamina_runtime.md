...
```bash
rg -n "Fatigue|PlayerCondition|HungerManager|Stamina|Sleep|Exhausted|PlayerRested|FatigueChanged|SleepQuality" Assets/_Game/Scripts docs/design docs/specs
