...
```bash
rg -n "QuestStateSection|QuestStateRecord|ObjectiveStates|KnownObjectiveIds|ChoiceHistory|GrantedRewardIds|GrantedFlagIds|QuestFlags|MainProgressionSection|FonteAnyaSection" Assets/_Game/Scripts docs/design docs/specs
