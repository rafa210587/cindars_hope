...
> Escopo: Completar entrada cave, loadout, morte, Fonte de Anya, corpse recovery e penalidades.
...
## Objetivo
Completar entrada cave, loadout, morte, Fonte de Anya, corpse recovery e penalidades.
...
## Arquitetura
Cave entry, player death, save, NPC/Anya, inventory e UI. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Cave entry, player death, save, NPC/Anya, inventory e UI.
...
## Riscos de regressao
Skill respec e UI podem criar fluxos sem falha/recovery definidos.
