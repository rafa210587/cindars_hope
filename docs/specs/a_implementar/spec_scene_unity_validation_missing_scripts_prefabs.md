# SPEC - Validacao Unity de cenas, prefabs e missing scripts

> Spec ID: spec_scene_unity_validation_missing_scripts_prefabs
...
> Escopo: Criar validacao local/batchmode para compile, missing scripts, prefabs, cenas e referencias criticas.
> Fora de escopo: Implementar gameplay nesta tarefa documental; alterar Assets, Packages, ProjectSettings, docs_old ou codigo C#.

Fontes absorvidas:
- docs/refinements/a_implementar/pre_refinamentos/refinamento_init_scene_unity_validation_missing_scripts_prefabs.md
...
## Objetivo
Criar validacao local/batchmode para compile, missing scripts, prefabs, cenas e referencias criticas.
...
## Arquitetura
Editor validators, scenes, prefabs e relatorios de validacao. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Editor validators, scenes, prefabs e relatorios de validacao.
...
## Riscos de regressao
Mudancas runtime podem mascarar problemas de cena/prefab.
