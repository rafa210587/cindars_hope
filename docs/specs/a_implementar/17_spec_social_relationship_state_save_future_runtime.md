...
```bash
rg -n "SocialRelationship|RelationshipStatus|Friendship|Trust|Affection|Polycule|SocialMemory|RomanceEligibility|TooYoung" Assets/_Game/Scripts docs/design docs/specs
