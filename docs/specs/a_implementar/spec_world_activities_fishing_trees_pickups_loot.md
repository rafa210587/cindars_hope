...
> Escopo: Completar pesca, arvores, pickups persistentes e loot tables de atividades.
...
## Objetivo
Completar pesca, arvores, pickups persistentes e loot tables de atividades.
...
## Arquitetura
World, farm activities, loot, save e inventory. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
World, farm activities, loot, save e inventory.
...
## Riscos de regressao
Loot/economy podem ser balanceados sobre drops incompletos.
