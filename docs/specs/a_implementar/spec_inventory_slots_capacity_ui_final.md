# SPEC - Inventory slots, capacidade e UI final
...
> Escopo: Evoluir Dictionary<string,int> para slots reais, multiplas stacks, capacidade, drag/drop e UI.
...
## Objetivo
Evoluir Dictionary<string,int> para slots reais, multiplas stacks, capacidade, drag/drop e UI.
...
## Arquitetura
Inventory, hotbar, equipment UI e save. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Inventory, hotbar, equipment UI e save.
...
## Riscos de regressao
Economy, craft e equipment podem depender de um modelo de inventory ainda provisorio.
