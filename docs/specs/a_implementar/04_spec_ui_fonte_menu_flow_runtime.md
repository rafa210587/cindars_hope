...
> **Depends on:**  
  ...
  - `docs/specs/a_implementar/03_spec_quest_fonte_main_progression_hooks_future.md`
...
```bash
rg -n "Fonte|FonteAnya|MainProgression|Fragment|LivingWater|Água Viva|Respec|Purification|FinalChoice|Anya|Level101|Nível 101" Assets/_Game/Scripts docs/design docs/specs
