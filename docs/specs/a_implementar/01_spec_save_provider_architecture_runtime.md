...
> **Repo lock scope:** `Assets/_Game/Scripts/Save/**`, `Assets/_Game/Scripts/**/**SaveData.cs`, `Assets/_Game/Scripts/**/**SaveProvider*.cs`, `docs/specs/SPEC_SAVE_SECTION_OWNERSHIP_REGISTRY.md`, `docs/validation/01_spec_save_provider_architecture_runtime_execution_report.md`.  
> **Depends on:**  
...
docs/design/gameplay/save_load/SAVE_LOAD_FULL_STATE_DIRECTION.md
docs/specs/SPEC_SAVE_SECTION_OWNERSHIP_REGISTRY.md, se criado pela spec 01.04
