...
> **Depends on:**  
  ...
  - `docs/specs/a_implementar/04_spec_ui_skill_tree_active_slots_runtime.md`
> **Blocks:**  
...
```bash
rg -n "Magic|Spell|SpellActionData|MPCost|Cooldown|CastTime|Recovery|SpellShape|SpellCategory|ActiveSlot|Dash|Dodge|Block|Tome|Scroll|Wand|Focus" Assets/_Game/Scripts docs/design docs/specs
