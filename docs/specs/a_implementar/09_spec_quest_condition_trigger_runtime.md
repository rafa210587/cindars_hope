...
```bash
rg -n "QuestCondition|ConditionResolver|QuestTrigger|TriggerRouter|QuestEvent|OnItemCollected|OnCropHarvested|OnCaveDepthReached|Retroactive|Deduplication" Assets/_Game/Scripts docs/design docs/specs
