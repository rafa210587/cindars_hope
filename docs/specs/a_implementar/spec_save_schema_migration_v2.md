...
> Escopo: Implementar migracao robusta de save com versao, backup e DTOs simples.
> Fora de escopo: Implementar gameplay nesta tarefa documental; alterar Assets, Packages, ProjectSettings, docs_old ou codigo C#.

Fontes absorvidas:
- specs/FASE9E_SAVE_SCHEMA_MIGRATION/spec.md
- specs/FASE9E_SAVE_SCHEMA_MIGRATION/plan.md
- specs/FASE9E_SAVE_SCHEMA_MIGRATION/tasks.md
...
## Objetivo
Implementar migracao robusta de save com versao, backup e DTOs simples.
...
## Arquitetura
SaveManager, DTOs de save e validadores. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
SaveManager, DTOs de save e validadores.
...
## Riscos de regressao
Specs posteriores podem persistir dados sem contrato de migracao.
