...
```bash
rg -n "CalendarPublic|CalendarBoard|ForecastTier|WeatherForecast|LunarForecast|SecretEvent|ShopClosure|QuestEvent" Assets/_Game/Scripts docs/design docs/specs
