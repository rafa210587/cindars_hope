...
```bash
rg -n "Festival|SeasonalEvent|Minigame|Participation|FestivalReward|FestivalQuest|FestivalActivity|FestivalWindow" Assets/_Game/Scripts docs/design docs/specs
