...
```bash
rg -n "Level101Encounter|Level101Reward|NoFarm|NoCommonPacks|NoCommonMining|RewardLock|BossDefeatState|RetryPolicy" Assets/_Game/Scripts docs/design docs/specs
