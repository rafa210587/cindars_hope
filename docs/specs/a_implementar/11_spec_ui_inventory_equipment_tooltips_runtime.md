...
```bash
rg -n "InventoryItemViewModel|ItemTooltip|Tooltip|EquipmentComparison|ProtectedItem|QuestItem|KeyItem|Unique|StackSplit|CanSell" Assets/_Game/Scripts docs/design docs/specs
