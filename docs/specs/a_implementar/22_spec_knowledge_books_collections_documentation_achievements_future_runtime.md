...
```bash
rg -n "KnowledgeBook|KnowledgeCollection|DocumentationMilestone|KnowledgeAchievement|LoreDocument|CollectionReward|DocumentationProgress" Assets/_Game/Scripts docs/design docs/specs
