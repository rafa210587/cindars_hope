...
```bash
rg -n "FinalChoicePresentation|FinalChoicePreview|CinematicPlayback|EndgameCinematic|ConfirmationPolicy|EndingCard|SkipCinematic" Assets/_Game/Scripts docs/design docs/specs
