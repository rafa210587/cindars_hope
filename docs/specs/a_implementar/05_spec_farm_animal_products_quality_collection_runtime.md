...
> **Depends on:**  
  ...
  - `docs/specs/a_implementar/05_spec_farm_fertilizer_crop_quality_runtime.md`
> **Blocks:**  
...
```bash
rg -n "AnimalProduct|ProductReady|Milk|Egg|Wool|FertilizerBase|AnimalProductCollected|ProductQuality|CareScore" Assets/_Game/Scripts docs/design docs/specs
