...
| Report | Execution report foi criado? | `docs/validation/03_spec_quest_festival_expiry_runtime_execution_report.md`. | PARTIAL |
...
```md
# Execution Report — Quest Festival Expiry Runtime
