...
```bash
rg -n "CityZone|CityBuilding|DoorTrigger|BedId|NpcSchedule|SchedulePeriod|OpenHoursRule|NightShop|FestivalOverride|Waypoint|Footbox" Assets/_Game/Scripts docs/design docs/specs
