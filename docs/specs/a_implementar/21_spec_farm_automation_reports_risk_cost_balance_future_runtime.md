...
```bash
rg -n "AutomationReport|ExpectedOutput|ActualOutput|FailureReason|RiskWarning|ManualReview|CostBreakdown|EndgameMana" Assets/_Game/Scripts docs/design docs/specs
