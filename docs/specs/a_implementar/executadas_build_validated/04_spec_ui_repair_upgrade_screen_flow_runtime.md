...
> **Depends on:**  
  ...
  - `docs/specs/a_implementar/04_spec_ui_equipment_compare_runtime.md`
  - `docs/specs/a_implementar/04_spec_ui_empty_error_confirmation_patterns_runtime.md`
> **Blocks:**  
...
```bash
rg -n "Repair|Upgrade|Durability|MaterialCost|GoldCost|BeforeAfter|Blacksmith|Service|Confirmation|ItemInstance" Assets/_Game/Scripts docs/design docs/specs
...
```bash
rg -n "Weapon|Armor|Repair|Upgrade|Spell|Magic|Gamepad|Navigation|Focus|Detail|Durability|Material|MP|Cooldown|Requirement" Assets/_Game/Scripts docs/design docs/specs
```
