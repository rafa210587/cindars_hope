...
```bash
rg -n "ItemDefinition|ItemCategory|ItemTag|Quality|Rarity|BaseValue|CanSell|CanBuy|QuestItem|KeyItem|Unique|ItemStack|ItemInstance" Assets/_Game/Scripts docs/design docs/specs
