...
```bash
rg -n "QuestLog|QuestDetail|QuestVisibility|QuestState|QuestFlag|MainQuest|FarmOrder|WaitingForTime|WaitingForWeather|WaitingForLunarEvent|Hidden|Expired" Assets/_Game/Scripts docs/design docs/specs
