...
```text
- `docs/specs/SPEC_IMPLEMENTABLE_TEMPLATE.md` existe e define Testing Quality Gate obrigatório para toda spec nova.
- `docs/specs/SPEC_WAVE_EXECUTION_PROTOCOL.md` existe e define protocolo de execução por waves.
- `docs/specs/SPEC_VALIDATION_MATRIX_MASTER.md` existe e define status caps e evidência mínima por tipo de mudança.
...
```bash
rg -n "Testing Quality Gate|testing-quality-gate|DEFERRED_TO_FINAL_HUMAN_VALIDATION|docs/05_VALIDATION|human test|Play Mode humano|manual scenario|ACCEPTED|BUILD_VALIDATED|PARTIAL" CLAUDE.md AGENTS.md .claude docs/specs docs/validation
...
```bash
rg -n "docs/05_VALIDATION|human test por spec|Play Mode humano obrigatório por spec|manual scenario" CLAUDE.md AGENTS.md .claude docs/specs docs/validation
rg -n "Testing Quality Gate|DEFERRED_TO_FINAL_HUMAN_VALIDATION|SPEC_VALIDATION_MATRIX_MASTER" CLAUDE.md .claude docs/specs docs/validation
```
