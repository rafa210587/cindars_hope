...
```bash
rg -n "Equipment|Weapon|Armor|Shield|Accessory|Relic|Material|Tier|Durability|KnownInteraction|Vulnerability|Bestiary|Tooltip|DetailDrawer" Assets/_Game/Scripts docs/design docs/specs
