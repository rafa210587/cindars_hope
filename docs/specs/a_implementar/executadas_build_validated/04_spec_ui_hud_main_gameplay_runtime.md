...
```bash
rg -n "HudController|HudViewModel|NotificationToast|ContextHint|Hotbar|ActiveSlot|PlayerStats|DebugHud|HP|Stamina|Hunger|Fatigue|Mana" Assets/_Game/Scripts docs/design docs/specs
