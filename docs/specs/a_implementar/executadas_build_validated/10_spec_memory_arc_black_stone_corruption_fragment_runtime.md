...
```bash
rg -n "MemoryArc|BlackStone|PedraNegra|Corruption|LivingWaterCorruption|Vaelrion|Sethra|Archivist|SoulDrain|MemoryDrain" Assets/_Game/Scripts docs/design docs/specs
