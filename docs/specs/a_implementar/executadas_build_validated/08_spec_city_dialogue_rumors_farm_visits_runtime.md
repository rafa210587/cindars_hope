...
```bash
rg -n "DialogueSet|DialogueContext|DialogueCondition|Rumor|FarmVisit|RelationshipThreshold|Spoiler|Anya|Romance|Pet" Assets/_Game/Scripts docs/design docs/specs
