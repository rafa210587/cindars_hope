...
> **Domain:** docs/specs registries / roadmap / README / source-of-truth references  
> **Parallelizable:** YES  
...
> **Repo lock scope:** `docs/specs/SPEC_REGISTRY_TO_IMPLEMENT.md`, `docs/specs/SPEC_GENERATION_ROADMAP_MASTER.md`, `docs/specs/README.md`, `docs/specs/SPEC_SOURCE_OF_TRUTH.md`, `docs/validation/12_spec_registry_roadmap_reconciliation_closeout_docs_execution_report.md`  
> **Depends on:**  
...
Após a geração em lotes, o repo terá várias specs novas em `docs/specs/a_implementar/`. Os registries e roadmap precisam refletir os arquivos concretos para evitar execução errada, duplicação e perda de rastreabilidade.
...
```text
auditar arquivos em docs/specs/a_implementar;
...
```text
docs/specs/SPEC_REGISTRY_GENERATED.md
docs/specs/SPEC_GENERATION_CLOSEOUT_REPORT.md
```
...
```text
1. Enumerar arquivos reais em docs/specs/a_implementar.
...
- [ ] T002 — Enumerar `docs/specs/a_implementar/*.md`.
...
```bash
rg -n "SPEC_REGISTRY|SPEC_GENERATION_ROADMAP|SPEC_CREATED|READY_FOR_IMPLEMENTATION|STRUCTURAL_FIX_REQUIRED|ARCHIVE_CANDIDATE|a_implementar" docs/specs docs/validation .claude/rules .claude/skills CLAUDE.md
