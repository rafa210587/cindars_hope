...
```bash
rg -n "LootTable|RewardTable|LootEntry|GuaranteedDrops|WeightedDrops|RareDrops|UniqueDrops|FirstTimeBonus|RepeatFarmRules|PityRules" Assets/_Game/Scripts docs/design docs/specs
