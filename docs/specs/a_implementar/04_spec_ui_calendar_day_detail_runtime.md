...
> **Depends on:**  
  ...
  - `docs/specs/a_implementar/02_spec_calendar_ui_weather_lunar_display.md`
...
```bash
rg -n "Calendar|DayDetail|Weather|TomorrowWeather|Lunar|Festival|FarmOrder|Deadline|Birthday|ShopClosed|QuestWaiting|HiddenEvent|Nyx|Level101" Assets/_Game/Scripts docs/design docs/specs
