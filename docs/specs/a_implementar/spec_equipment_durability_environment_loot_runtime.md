...
> Escopo: Completar equipment slots, durabilidade, resistencias ambientais e loot runtime.
...
## Objetivo
Completar equipment slots, durabilidade, resistencias ambientais e loot runtime.
...
## Arquitetura
Equipment, loot, craft, player stats, cave e save. devem seguir managers/bridges Unity finos, dados em ScriptableObject e logica de negocio fora de MonoBehaviour pesado.

## Sistemas afetados
Equipment, loot, craft, player stats, cave e save.
...
## Riscos de regressao
Damage e enemy tuning ficam instaveis sem stats/equipment finais.
