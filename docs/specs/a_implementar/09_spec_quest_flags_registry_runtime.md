...
```bash
rg -n "QuestFlag|FlagRegistry|FlagId|QuestFlagGrant|QuestFlagClear|FonteRespawnUnlocked|ShopNightUnlocked|ArchivistNameKnown|MainProgression|FonteAnya" Assets/_Game/Scripts docs/design docs/specs
