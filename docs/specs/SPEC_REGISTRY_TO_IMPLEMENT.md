...
| 17F | [spec_ui_gameplay_shop_modal_stack_responsive_names_closeout.md](a_implementar/spec_ui_gameplay_shop_modal_stack_responsive_names_closeout.md) | Implementado em codigo - Unity/Play Mode pendentes | 17E implementada em codigo | Modal pop condicional, detalhes e scroll implementados; manter ativo ate confirmar alternancia Buy/Sell sem mismatch. |
