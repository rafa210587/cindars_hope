...
| 17 | [spec_ui_ux_full_gameplay_inventory_hotbar_menus.md](a_implementar/spec_ui_ux_full_gameplay_inventory_hotbar_menus.md) | A implementar | 00-16 implementadas/parciais | UI final consolidada. Depende de todas specs 00-16. Sem bloqueadores. |
