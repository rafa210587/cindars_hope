...
> **Local:** `docs/specs/SPEC_IMPLEMENTABLE_TEMPLATE.md`  
> **Tipo:** guia/template, não é spec implementável.  
> **Função:** padronizar como novas specs em `docs/specs/a_implementar/` devem ser escritas para execução futura por Codex ou Claude Code.  
...
Antes de criar uma spec em `docs/specs/a_implementar/`, conferir:
...
Verifique:
- se segue docs/specs/SPEC_IMPLEMENTABLE_TEMPLATE.md;
