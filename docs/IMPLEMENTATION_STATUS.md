...
| Architecture Reorganization / Validator Foundation (SpecKit SPEC_00-03) | Implementado completo | SPEC_00: estrategia sequencial, anti-drift rules; SPEC_01: fundacao ValidationSeverity/ValidationIssue/ValidationReport/IProjectValidator/ProjectValidationRunner editor-only; SPEC_02 (projectile prefab validator) + SPEC_03 (combat database validators) merged em dev 2026-06-01; docs/validation/spec_arch_reorg_*.md com execution reports. Builds C# 0 erros; Unity validation pendente (editor-only codigo). |
