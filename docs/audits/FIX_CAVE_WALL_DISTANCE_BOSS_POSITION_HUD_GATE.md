...
2. **Diagonal tiles** (distance ≈ 1.4): all 4 diagonals
...
|---|------|----------|--------|
| 1 | Wall left | Muito perto, não penetra | ⬜ |
| 2 | Wall right | Muito perto, não penetra | ⬜ |
| 3 | Wall robust | Sem penetração forçada | ⬜ |
| 4 | Boss adjacent | Spawna distância <= 1 | ⬜ |
| 5 | Gate blocks | Não pode entrar 15→16 antes derrota | ⬜ |
| 6 | HUD before | Mostra "active / blocked" | ⬜ |
| 7 | Boss defeat | Mata boss, logs aparecem | ⬜ |
| 8 | HUD after | Mostra "defeated / open" | ⬜ |
| 9 | Advancement | Consegue avançar 15→16 | ⬜ |
| 10 | Level 16 | Mostra "No gate" | ⬜ |
...
4. 🔄 Commit: `Fix cave wall distance, boss position, and HUD gate status`
