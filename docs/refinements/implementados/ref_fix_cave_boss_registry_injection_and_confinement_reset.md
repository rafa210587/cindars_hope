...
|---|------|----------|--------|
| 1 | Registry null check | Sem erro "Registry is null" | â¬œ |
| 2 | Boss spawn level 15 | Boss visível perto ForwardExit | â¬œ |
| 3 | Boss blocks 15→16 | Avanço bloqueado antes derrota | â¬œ |
| 4 | Defeat unlocks gate | Avanço permitido após derrota | â¬œ |
| 5 | Wall tolerance left | Consegue chegar perto parede esq | â¬œ |
| 6 | Wall tolerance right | Consegue chegar perto parede dir | â¬œ |
| 7 | No old teleport | Não volta para lastValid antigo | â¬œ |
| 8 | Per-axis rollback | Desliza suave, não joga para trás | â¬œ |
| 9 | No jitter | Smooth contra parede, sem tremor | â¬œ |
| 10 | Save/load state | Boss defeat e checkpoint persistem | â¬œ |
...
4. ðŸ”„ Adjust tuning parameters if needed
5. ðŸ”„ Commit: `Fix cave boss registry injection and confinement reset`
6. ðŸ”„ Create PR against `dev`
