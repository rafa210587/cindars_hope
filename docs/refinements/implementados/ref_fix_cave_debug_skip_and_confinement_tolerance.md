...
|---|------|----------|--------|
| 1 | Button visível | Botão aparece no canto superior esquerdo | â¬œ |
| 2 | Button click | Click sobe CaveLevel, logs aparecem | â¬œ |
| 3 | P hotkey | P sobe CaveLevel (se input funciona) | â¬œ |
| 4 | F2 hotkey | F2 sobe CaveLevel | â¬œ |
| 5 | Wall tolerance (left) | Player consegue chegar mais perto parede esq | â¬œ |
| 6 | Wall tolerance (right) | Player consegue chegar mais perto parede dir | â¬œ |
| 7 | No wall penetration | Player não atravessa parede | â¬œ |
| 8 | No jitter | Player não treme contra parede | â¬œ |
| 9 | Console clean | Sem erros vermelhos em 1 minuto de gameplay | â¬œ |
| 10 | Checkpoint locked | F2 skip não desbloqueia checkpoint 15 | â¬œ |
...
2. ðŸ”„ Execute 10-test sequence above
