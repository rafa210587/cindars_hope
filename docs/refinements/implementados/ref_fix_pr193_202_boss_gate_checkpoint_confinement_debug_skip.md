...
### Play Mode tests (ðŸ”„ pending)
11. ðŸ”„ P hotkey increments level without changing CaveRunSeed
12. ðŸ”„ P hotkey doesn't mark boss defeated
13. ðŸ”„ P hotkey doesn't unlock checkpoint
14. ðŸ”„ P hotkey respects boss gate if `_bypassBossGateForDebugSkip = false`
15. ðŸ”„ Level 15 spawns boss if not defeated
16. ðŸ”„ Level 15 doesn't spawn boss if defeated
17. ðŸ”„ ForwardExit 15→16 blocks before boss defeat with explicit error
18. ðŸ”„ ForwardExit 15→16 allows after boss defeat
19. ðŸ”„ KO doesn't relock 15→16
20. ðŸ”„ Save/load preserves boss defeat
21. ðŸ”„ Cave→Farm→Cave doesn't relock
22. ðŸ”„ Checkpoint selection shows when multiple available
23. ðŸ”„ Checkpoint selection auto-selects when single
24. ðŸ”„ Player cannot traverse WallTiles
25. ðŸ”„ Player cannot exit dungeon bounds
26. ðŸ”„ HUD shows boss gate status
27. ðŸ”„ HUD shows debug skip status
28. ðŸ”„ Validators report all issues
29. ðŸ”„ Console shows no red errors during boss defeat, checkpoint unlock, path confinement
