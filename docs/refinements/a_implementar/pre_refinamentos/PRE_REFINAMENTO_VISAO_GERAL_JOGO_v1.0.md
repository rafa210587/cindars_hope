...
> **status: delete_candidate** — superseded-by `PRE_REFINAMENTO_VISAO_GERAL_JOGO_v1.1.md` (vigente). Mantido como histórico; candidatado à deleção em `docs/project/DOCUMENT_DELETE_CANDIDATES.md` (fable_67, 2026-06-19). Decisão final de deleção é humana.  
