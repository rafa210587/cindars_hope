...
O projeto possui HUD/debug e alguns managers/painÃ©is mÃ­nimos, mas ainda nÃ£o possui UI final integrada.
...
- Debug HUD nÃ£o Ã© UI final.
- Inventory nÃ£o tem grid/slots/drag/drop.
- Hotbar nÃ£o estÃ¡ completa visualmente.
- Equipment screen nÃ£o estÃ¡ completa.
- Crafting UI nÃ£o estÃ¡ completa.
- Skill tree UI nÃ£o existe de forma final.
- Shop UI nÃ£o estÃ¡ completa.
- Cave/death/corpse UI nÃ£o estÃ¡ completa.
- Pause/options/save slot UI ainda precisa consolidaÃ§Ã£o.
- Falta navegaÃ§Ã£o consistente por teclado/controle/mouse.
...
- Um menu modal por vez, salvo overlays explÃ­citos.
- Player movement bloqueado quando menu modal abre.
- ESC fecha menu atual antes de abrir pause.
- Hotbar continua visÃ­vel durante gameplay normal.
...
- Arte final de todos os Ã­cones.
- Controller remapping avanÃ§ado.
- Acessibilidade completa.
- LocalizaÃ§Ã£o multilÃ­ngue completa.
...
- [ ] UI atualiza via eventos, nÃ£o polling pesado.
