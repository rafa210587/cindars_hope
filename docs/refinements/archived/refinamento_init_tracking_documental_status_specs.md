...
Nao usar como backlog vivo nem gerar nova spec a partir dele.

Pendencias remanescentes foram movidas para hardening documental:

- corrigir encoding dos pre-refinamentos quando forem refinados;
- enriquecer specs futuras 01-17 com seus pre-refinamentos;
- marcar/mover cada pre-refinamento como absorvido quando sua spec relacionada for amadurecida.
