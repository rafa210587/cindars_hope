...
> **Local:** `docs/design/art/CAVE_MONSTER_VISUAL_SPRITE_DIRECTION.md`  
> **Depende de:**  
...
## 10b. Expansão fable_80 — Ninrorin, Abismo/Vazio, Corrompido e Drow (níveis 71-99)

> Famílias adicionadas ao bestiário depois da redação original deste documento (expansão de 40 criaturas, fable_80). Cada uma já existe como `bestiary_*.asset`. Marcadores de variante aplicáveis: Corrompido (veios pretos, olhos roxos, partículas de Pedra Negra), Lunar/Nyx (azul-escuro/prateado), Abissal (negro-vazio com fendas roxas). Níveis aproximados informados pela família; ver asset para placement exato de bioma.

**Linhagem Ninrorin do Vazio** (elfos cinzentos corrompidos por Nyx/vazio — mesma raça de Thalindra/Velorin, mas tomada pela fenda):

```text
enemy_ninrorin_void_sentinel — Sentinela Ninrorin do Vazio
Silhueta: elfo cinzento alto e imóvel, armadura ritual com lança e escudo de pedra-fenda.
Cores: cinza-pálido, prata fosca, fissura negra-roxa pulsando no peito.
Animações: idle de guarda, slam de escudo, estocada, baixar guarda (vulnerável).
Leitura: tank/guardião — brecha quando o escudo desce.

 enemy_ninrorin_void_knight — Cavaleiro Ninrorin do Vazio
Silhueta: elfo cinzento em armadura completa lunar, espada longa de fenda, capa esfarrapada.
Cores: cinza-azulado, prata, roxo-vazio nas juntas da armadura.
Animações: avanço, corte amplo, combo de duas lâminas, recovery.
Leitura: bruiser agressivo, fecha distância.

 enemy_ninrorin_void_acolyte — Acólito Ninrorin do Vazio
Silhueta: elfo cinzento esguio, manto ritual com capuz, mãos erguidas em conjuração.
Cores: cinza, azul-noite, energia negra-roxa nas mãos, olhos brancos sem íris.
Animações: cast windup (mãos/olhos brilham), release de bile do vazio, recuar.
Leitura: caster — telegraph claro antes do projétil.

 enemy_ninrorin_phasewalker — Caminhante de Fase Ninrorin
Silhueta: elfo cinzento meio translúcido, contorno duplicado, pisca entre posições.
Cores: cinza-prata, azul-fantasma, bordas que desfocam e deixam rastro.
Animações: idle instável, blink curto, golpe ao reaparecer, dissipar.
Leitura: evasivo — reaparece pelo flanco.

 enemy_ninrorin_echo_shade — Sombra-Eco Ninrorin
Silhueta: vulto cinzento quase incorpóreo, restos de véu ritual flutuando, rosto apagado.
Cores: cinza-fumaça, prata, núcleo azul-frio; ecos atrasados seguem o corpo.
Animações: deriva, swipe espectral, multiplicar eco, esvair ao morrer.
Leitura: frágil e esquivo, confunde mira.
```

**Aberrações do Abismo / Vazio** (níveis 71-85+):

```text
enemy_void_spitter — Cuspidor do Vazio
Silhueta: aberração baixa e inchada, boca vertical grande, glândulas que incham antes do cuspe.
Cores: roxo-escuro, preto, bile ácida violeta na garganta (brilha no windup).
Animações: idle pulsante, inflar garganta, cuspir projétil, recuar.
Leitura: artilheiro estacionário.

 enemy_void_tick — Carrapato do Vazio
Silhueta: parasita minúsculo, carapaça negra com fissura roxa no dorso, patas rápidas.
Cores: preto-vazio, veios roxos, brilho mínimo nos olhos.
Animações: correr, saltar e grudar, drenar, estourar ao morrer.
Leitura: swarm frágil que adere.

 enemy_abyssal_riftstalker — Espreitador da Fenda Abissal
Silhueta: predador médio esguio, membros longos, corpo recortado do escuro.
Cores: negro-abissal, contorno roxo, olhos sem brilho.
Animações: esgueirar, abrir fenda, investir pela fenda (blink), corte.
Leitura: caçador que teleporta pelo abismo.

 enemy_abyssal_void_reaver — Ceifador do Vazio Abissal
Silhueta: aberração grande e imponente, dois braços-lâmina de energia, fendas rasgando o tronco.
Cores: preto, roxo-vazio intenso, brasa fria azul nas feridas.
Animações: idle pesado, sweep duplo telegrafado, investida, vulnerável após combo.
Leitura: elite bruiser — telegraph longo.

 enemy_shadow_sentinel — Sentinela das Sombras
Silhueta: guardião alto de sombra sólida, núcleo escuro exposto no peito.
Cores: preto-fosco, cinza-sombra, núcleo roxo-frio.
Animações: idle imóvel, despertar, sweep amplo, núcleo abre (vulnerável).
Leitura: tank — só vulnerável com o núcleo exposto.
```

**Drow** (níveis 71-85, complementa a seção 9):

```text
enemy_drow_shadow_warden — Guardião das Sombras Drow
Silhueta: drow robusto e blindado (mais pesado que a Lâmina Sombria), escudo escuro e maça/lâmina.
Cores: pele cinza-violácea, cabelo branco, prata-escuro, manto negro, olhos vermelhos.
Animações: postura de guarda, bash de escudo, golpe pesado, cobrir aliado.
Leitura: defensor de linha — protege casters atrás.
```

**Corrompidos / Dracônicos** (níveis 86-99):

```text
enemy_corrupted_bone_knight — Cavaleiro de Osso Corrompido
Silhueta: morto-vivo blindado, armadura rachada sobre ossos, postura pesada.
Cores: osso gasto, metal escuro, veios pretos de Pedra Negra, olhos roxos.
Animações: arrastar, estocada lenta, golpe duplo, desmontar ao morrer.
Leitura: bruiser lento e resistente.

 enemy_corrupted_draconic_spawn — Cria Dracônica Corrompida
Silhueta: filhote de dragão deformado, escamas negro-roxas, asas rasgadas.
Cores: negro-roxo opaco, baba/veios de Pedra Negra, brasa roxa na garganta.
Animações: voo baixo, mergulho, mordida, lufada corrompida.
Leitura: ágil, ataca em mergulho.

 enemy_draconic_elder_kin — Ancião da Linhagem Dracônica
Silhueta: dracônido grande e antigo, porte de patriarca, placas no peito, chifres longos.
Cores: escamas escuras com brilho roxo-mana, placas cinza-ferro, olhos âmbar-corrompido.
Animações: idle imponente, garra, sopro de energia corrompida (telegraph forte), recovery.
Leitura: elite — janela após o sopro.
```
