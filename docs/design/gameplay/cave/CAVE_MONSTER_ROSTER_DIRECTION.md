...
## 1. Progressão do jogador usada como régua

Regra de progressão do player:
...
A caverna não deve assumir que o jogador está perfeitamente otimizado, mas os monstros precisam ser ameaça real.
...
## 3. Escala real de atributos por faixa

A escala anterior 1-8 era insuficiente. A escala canônica passa a usar valores reais compatíveis com progressão do jogador.
...
```text
Monstro comum não precisa ter todos os atributos altos.
Ele deve ser ameaçador porque seus atributos dominantes são altos para sua função.
Atributos fracos continuam baixos para criar leitura e counterplay.
```

## 4. HP/MP/Stamina/Breath por faixa

| Faixa | Comum HP | Elite HP | Boss HP | Observação |
|---:|---:|---:|---:|---|
| 1-10 | 25-80 | 90-160 | — | tutorial com risco real |
| 11-25 | 70-160 | 180-320 | 900-1300 | primeiro boss gate |
| 26-40 | 130-280 | 320-560 | 1500-2200 | dano ambiental começa pesar |
| 41-55 | 220-420 | 500-850 | 2500-3600 | fogo e pressão agressiva |
| 56-70 | 360-650 | 750-1200 | 4000-5600 | ruínas/constructos resistentes |
| 71-85 | 560-900 | 1100-1800 | 6500-8500 | abismo e controllers |
| 86-99 | 780-1300 | 1600-2600 | 9000-13000 | núcleo corrompido |
| 100 | — | 2200-3600 | 15000-19000 | gate final |
| 101 | — | — | 18000+ | bosses em sequência |

MP deve existir em criaturas mágicas/casters/aberrantes. Criaturas puramente físicas podem ter MP 0.

Breath/Fôlego importa para:

```text
perseguir por tempo longo
usar investidas repetidas
resistir a cansaço/controle
lutar em hazards de calor/frio/gás
```

## 5. Scaling por nível da caverna

Cada inimigo possui faixa nativa. Se aparecer acima ou abaixo dela:
...
Todo boss gate deve ter pelo menos 2 fases. Bosses de gate final/101 devem ter 3 fases.
...
## 11. Factions oficiais da caverna
...
## 12. Size classes e footprint visual
...
HP 42 | MP 0 | STA 28 | BR 24 | FOR 4 | CON 5 | DES 6 | INT 1 | VON 2 | CAR 0 | XP 10
...
HP 32 | MP 8 | STA 26 | BR 34 | FOR 2 | CON 2 | DES 8 | INT 2 | VON 3 | CAR 0 | XP 12
...
HP 58 | MP 0 | STA 36 | BR 30 | FOR 4 | CON 4 | DES 7 | INT 4 | VON 3 | CAR 3 | XP 16
...
HP 54 | MP 0 | STA 38 | BR 34 | FOR 3 | CON 4 | DES 7 | INT 5 | VON 3 | CAR 2 | XP 16
...
HP 74 | MP 8 | STA 24 | BR 20 | FOR 4 | CON 8 | DES 2 | INT 1 | VON 5 | CAR 0 | XP 14
...
HP 82 | MP 0 | STA 30 | BR 24 | FOR 7 | CON 5 | DES 4 | INT 1 | VON 5 | CAR 0 | XP 18
...
HP 68 | MP 18 | STA 18 | BR 16 | FOR 2 | CON 6 | DES 3 | INT 2 | VON 7 | CAR 0 | XP 18
...
HP 150 | MP 0 | STA 18 | BR 10 | FOR 8 | CON 12 | DES 1 | INT 1 | VON 6 | CAR 0 | XP 35
...
HP 70 | MP 0 | STA 42 | BR 32 | FOR 3 | CON 5 | DES 9 | INT 2 | VON 4 | CAR 0 | XP 22
...
HP 130 | MP 0 | STA 30 | BR 18 | FOR 10 | CON 9 | DES 4 | INT 2 | VON 5 | CAR 0 | XP 40
Ataques: AmbushBite, TongueGrabShort
Drops: madeira viva, dente de baú, loot guardado
```

## 14. Níveis 11-25 — Floresta Subterrânea

```text
enemy_spore_imp | Diabrete de Esporo
HP 95 | MP 34 | STA 44 | BR 38 | FOR 4 | CON 6 | DES 11 | INT 7 | VON 8 | CAR 2 | XP 22
Behavior CasterSupport | Move CasterKeepAway | Ataques: SporeShot, PoisonCloudSmall

 enemy_rootsnare | Garra-Raiz
HP 135 | MP 22 | STA 28 | BR 20 | FOR 8 | CON 13 | DES 3 | INT 2 | VON 10 | CAR 0 | XP 30
Behavior Ambusher/ResourceGuardian | Move BurrowAmbush | Ataques: RootGrab, ThornLash

 enemy_hollow_stagling | Cervino Oco
HP 160 | MP 0 | STA 70 | BR 64 | FOR 10 | CON 9 | DES 14 | INT 2 | VON 6 | CAR 0 | XP 55
Behavior Predator | Move Leaper/ChargeLine | Ataques: AntlerCharge, KickBack

 enemy_goblin_urudakh_trapper | Armeiro Uru'dakh
HP 110 | MP 0 | STA 58 | BR 44 | FOR 6 | CON 7 | DES 12 | INT 12 | VON 7 | CAR 4 | XP 28
Behavior FactionPatrol | Move KiteRanged/RetreatAndCall | Ataques: TrapPlace, JavelinThrow

 enemy_thorn_archer | Espinhador Sombrio
HP 118 | MP 10 | STA 60 | BR 52 | FOR 7 | CON 7 | DES 14 | INT 8 | VON 7 | CAR 3 | XP 32
Behavior Ranged | Move KiteRanged | Ataques: ThornShot, PinningShot

 enemy_orc_nyx_stalker | Espreitador Orc de Nyx
HP 170 | MP 18 | STA 72 | BR 68 | FOR 14 | CON 11 | DES 13 | INT 5 | VON 11 | CAR 3 | XP 48
Behavior PackHunter/Ambusher | Move PackFlanker/PhaseShortBlink leve | Ataques: ShadowCleave, AmbushDash

 enemy_mycobulwark | Baluarte Micélio
HP 280 | MP 26 | STA 42 | BR 36 | FOR 13 | CON 18 | DES 2 | INT 2 | VON 13 | CAR 0 | XP 75
Behavior ResourceGuardian/Tank | Move TankSlowPush/ProtectAnchor | Ataques: Slam, SporeGuardAura

 enemy_nyx_moth | Mariposa de Nyx
HP 90 | MP 42 | STA 50 | BR 60 | FOR 2 | CON 5 | DES 15 | INT 7 | VON 12 | CAR 2 | XP 38
Behavior CasterSupport/Swarm | Move FloatingOrbit | Ataques: MoonDust, FearFlutter leve

 enemy_root_owlbear | Urso-Coruja Raiz-Oca
HP 340 | MP 0 | STA 86 | BR 78 | FOR 18 | CON 17 | DES 9 | INT 2 | VON 9 | CAR 0 | XP 90
Behavior EliteDuelist/Predator | Move ChargeLine/Leaper | Ataques: HeavyClaw, RootRoar, BeakCrush

 enemy_basilisk_lizard | Lagarto Basilisco de Musgo
HP 240 | MP 38 | STA 48 | BR 42 | FOR 10 | CON 15 | DES 6 | INT 3 | VON 13 | CAR 0 | XP 85
Behavior Controller/Guard | Move GuardStationary/TankSlowPush | Ataques: SlowGaze, VenomBite

 enemy_panther_distorted | Pantera Distorcida
HP 220 | MP 24 | STA 92 | BR 82 | FOR 12 | CON 8 | DES 20 | INT 4 | VON 9 | CAR 0 | XP 95
Behavior EliteDuelist | Move PhaseShortBlink/PackFlanker | Ataques: PhasePounce, TwinClaw
```

## 15. Níveis 26-40 — Caverna de Gelo

```text
enemy_frost_gnawer | Roedor de Geada
HP 155 | MP 0 | STA 72 | BR 66 | FOR 9 | CON 9 | DES 16 | INT 2 | VON 7 | CAR 0 | XP 36
Behavior Predator | Move GroundChase | Ataques: ChillBite, PackRush

 enemy_duergar_frostdelver | Escavador Duergar do Gelo
HP 230 | MP 0 | STA 76 | BR 70 | FOR 15 | CON 16 | DES 7 | INT 8 | VON 11 | CAR 2 | XP 48
Behavior FactionPatrol/ResourceGuardian | Move GroundPatrol | Ataques: PickSwing, IceShardBreak

 enemy_duergar_shieldbreaker | Quebra-Escudo Duergar
HP 520 | MP 0 | STA 84 | BR 78 | FOR 22 | CON 22 | DES 5 | INT 7 | VON 14 | CAR 2 | XP 105
Behavior Tank/Elite | Move TankSlowPush | Ataques: ShieldCrush, GuardBreak

 enemy_icebound_sentinel | Sentinela Enregelado
HP 480 | MP 22 | STA 40 | BR 30 | FOR 18 | CON 24 | DES 3 | INT 5 | VON 18 | CAR 0 | XP 95
Behavior ConstructProtocol | Move GuardStationary/TankSlowPush | Ataques: IceSlam, ChillPulse

 enemy_glassbone | Osso de Vidro
HP 210 | MP 16 | STA 58 | BR 44 | FOR 12 | CON 8 | DES 15 | INT 2 | VON 16 | CAR 0 | XP 52
Behavior Ranged/Chaser | Move GroundChase/KiteRanged | Ataques: GlassShard, BoneLunge

 enemy_cold_cult_acolyte | Acólito do Frio
HP 190 | MP 70 | STA 48 | BR 42 | FOR 5 | CON 8 | DES 8 | INT 15 | VON 18 | CAR 5 | XP 58
Behavior CasterSupport/CultRitualist | Move CasterKeepAway | Ataques: FrostZone, ColdBolt

 enemy_crystal_leaper | Saltador Cristalino
HP 330 | MP 18 | STA 104 | BR 96 | FOR 16 | CON 12 | DES 24 | INT 3 | VON 12 | CAR 0 | XP 110
Behavior EliteDuelist | Move Leaper/ChargeLine | Ataques: CrystalLeap, ShardBurst

 enemy_frost_wailer | Lamento Frio
HP 300 | MP 90 | STA 52 | BR 60 | FOR 4 | CON 11 | DES 10 | INT 14 | VON 24 | CAR 0 | XP 125
Behavior Caster/Controller | Move FloatingSlow/CasterKeepAway | Ataques: WailPulse, ChillCone

 enemy_hook_horror_ice | Horror-Gancho de Gelo
HP 560 | MP 0 | STA 88 | BR 76 | FOR 24 | CON 21 | DES 8 | INT 3 | VON 13 | CAR 0 | XP 135
Behavior EliteDuelist/TerritorialGuard | Move GroundChase | Ataques: HookSweep, HookImpale

 enemy_mind_eater_larva | Larva Devora-Mentes
HP 240 | MP 96 | STA 50 | BR 44 | FOR 3 | CON 8 | DES 12 | INT 19 | VON 18 | CAR 1 | XP 120
Behavior AberrantController | Move CasterKeepAway | Ataques: PsychicPulse, AimDisrupt
```

## 16. Níveis 41-55 — Caverna de Fogo

```text
enemy_ember_tick | Carrapato de Brasa
HP 230 | MP 0 | STA 94 | BR 88 | FOR 8 | CON 9 | DES 23 | INT 1 | VON 8 | CAR 0 | XP 62
Behavior SwarmPressure | Move SwarmErratic | Ataques: EmberBite, MinorBurst

 enemy_ash_crawler | Rastejante de Cinza
HP 360 | MP 18 | STA 82 | BR 80 | FOR 18 | CON 17 | DES 13 | INT 2 | VON 12 | CAR 0 | XP 76
Behavior Predator | Move GroundChase/HazardLure | Ataques: AshClaw, BurnTrail

 enemy_orc_kaand_berserker | Berserker Orc de Kaand
HP 760 | MP 0 | STA 120 | BR 112 | FOR 30 | CON 23 | DES 12 | INT 4 | VON 20 | CAR 5 | XP 170
Behavior EliteDuelist/CorruptedFrenzy | Move ChargeLine/GroundChase | Ataques: RageCleave, LeapSmash

 enemy_orc_kaand_ashcaller | Chamador de Cinzas de Kaand
HP 440 | MP 110 | STA 70 | BR 84 | FOR 10 | CON 14 | DES 9 | INT 17 | VON 24 | CAR 8 | XP 135
Behavior CasterSupport/CultRitualist | Move CasterKeepAway | Ataques: AshCall, EmberBuff

 enemy_lava_bulwark | Baluarte de Lava
HP 820 | MP 40 | STA 52 | BR 45 | FOR 24 | CON 32 | DES 3 | INT 2 | VON 18 | CAR 0 | XP 150
Behavior Tank/ResourceGuardian | Move TankSlowPush | Ataques: LavaSlam, HeatAura

 enemy_cinder_spitter | Cuspidor de Cinza
HP 340 | MP 30 | STA 76 | BR 100 | FOR 12 | CON 12 | DES 17 | INT 3 | VON 11 | CAR 0 | XP 92
Behavior Ranged | Move KiteRanged | Ataques: CinderSpit, SmokeRetreat

 enemy_scorched_cultist | Cultista Chamuscado
HP 390 | MP 120 | STA 58 | BR 62 | FOR 7 | CON 12 | DES 9 | INT 20 | VON 22 | CAR 7 | XP 110
Behavior Caster/CultRitualist | Move CasterKeepAway | Ataques: BurnSigil, FireBolt

 enemy_furnace_warden | Guardião da Fornalha
HP 980 | MP 50 | STA 70 | BR 58 | FOR 26 | CON 34 | DES 4 | INT 10 | VON 24 | CAR 0 | XP 210
Behavior ConstructProtocol/Elite | Move ProtectAnchor/TankSlowPush | Ataques: FurnaceHammer, FlameVent

 enemy_fire_basilisk | Basilisco de Brasa
HP 720 | MP 80 | STA 72 | BR 78 | FOR 18 | CON 25 | DES 8 | INT 3 | VON 24 | CAR 0 | XP 185
Behavior Controller/Guard | Move GuardStationary/TankSlowPush | Ataques: HeatGaze, EmberBite

 enemy_stone_bulette | Tubarão de Pedra
HP 1150 | MP 0 | STA 125 | BR 116 | FOR 34 | CON 32 | DES 10 | INT 2 | VON 18 | CAR 0 | XP 260
Behavior BurrowPredator/Elite | Move BurrowAmbush/ChargeLine | Ataques: EmergeCrush, StoneBite
```

## 17. Níveis 56-70 — Ruínas Antigas

```text
enemy_rune_shard | Lasca Rúnica
HP 360 | MP 85 | STA 56 | BR 40 | FOR 6 | CON 14 | DES 18 | INT 12 | VON 18 | CAR 0 | XP 98
Behavior SwarmPressure/ConstructProtocol | Move FloatingOrbit | Ataques: RuneBolt, ArcSpark

 enemy_clockwork_guard | Guarda de Corda
HP 680 | MP 30 | STA 70 | BR 55 | FOR 22 | CON 28 | DES 7 | INT 10 | VON 22 | CAR 0 | XP 130
Behavior ConstructProtocol | Move GroundPatrol/ProtectAnchor | Ataques: GearStrike, LockdownStep

 enemy_gnome_gem_madcap | Gnomo de Gema Enlouquecido
HP 420 | MP 150 | STA 70 | BR 58 | FOR 6 | CON 12 | DES 16 | INT 28 | VON 16 | CAR 5 | XP 145
Behavior CasterSupport | Move KiteRanged | Ataques: GemBurst, ErraticBolt

 enemy_gnomorin_rune_tinker | Gnomorin Runa-Torta
HP 450 | MP 135 | STA 78 | BR 62 | FOR 7 | CON 13 | DES 18 | INT 30 | VON 18 | CAR 4 | XP 150
Behavior FactionPatrol/ConstructSupport | Move KiteRanged/RetreatAndCall | Ataques: RuneTrap, GearShot

 enemy_sealed_knight | Cavaleiro Selado
HP 1250 | MP 35 | STA 88 | BR 72 | FOR 32 | CON 36 | DES 8 | INT 5 | VON 30 | CAR 0 | XP 280
Behavior Tank/Elite | Move TankSlowPush | Ataques: SealedCleave, OathPulse

 enemy_mirror_adept | Adepto do Espelho
HP 620 | MP 190 | STA 82 | BR 78 | FOR 8 | CON 14 | DES 20 | INT 30 | VON 26 | CAR 10 | XP 260
Behavior Caster/EliteDuelist | Move PhaseShortBlink | Ataques: MirrorBolt, BlinkSlash

 enemy_puzzle_golem | Golem de Enigma
HP 1500 | MP 80 | STA 58 | BR 40 | FOR 30 | CON 42 | DES 4 | INT 20 | VON 34 | CAR 0 | XP 320
Behavior ConstructProtocol/Tank | Move ProtectAnchor | Ataques: LogicSlam, VulnerabilityCycle

 enemy_oathless_shade | Sombra Sem-Juramento
HP 720 | MP 180 | STA 86 | BR 88 | FOR 12 | CON 16 | DES 24 | INT 18 | VON 34 | CAR 0 | XP 300
Behavior Caster/Phase | Move PhaseShortBlink/FloatingSlow | Ataques: OathDrain, ShadeStep

 enemy_beholder_kin_lesser | Observador Menor da Ruína
HP 1100 | MP 260 | STA 70 | BR 90 | FOR 8 | CON 24 | DES 14 | INT 32 | VON 32 | CAR 4 | XP 360
Behavior AberrantController/Elite | Move FloatingOrbit/BossArenaControl menor | Ataques: BlackstoneBeamMinor, SlowGaze, EyeShardVolley

 enemy_mimic_armory | Arsenal-Mordente
HP 1250 | MP 0 | STA 58 | BR 36 | FOR 34 | CON 36 | DES 8 | INT 8 | VON 22 | CAR 0 | XP 340
Behavior TreasureTrap/Tank | Move TreasureIdleAmbush/TankSlowPush | Ataques: AmbushBite, WeaponRackSlam

 enemy_brain_jelly | Geleia-Memória
HP 760 | MP 230 | STA 50 | BR 42 | FOR 4 | CON 20 | DES 10 | INT 34 | VON 28 | CAR 0 | XP 310
Behavior AberrantController | Move FloatingSlow | Ataques: MemoryPulse, ConfusionLiteWave
```

## 18. Níveis 71-85 — Abismo Sombrio

```text
enemy_drow_shadowblade | Lâmina Sombria Drow
HP 900 | MP 60 | STA 130 | BR 118 | FOR 22 | CON 20 | DES 40 | INT 18 | VON 26 | CAR 8 | XP 390
Behavior EliteDuelist/PackHunter | Move PackFlanker/PhaseShortBlink | Ataques: ShadowBlade, BackstepSlash

 enemy_drow_moon_caster | Conjurador Lunar Drow
HP 760 | MP 300 | STA 86 | BR 90 | FOR 8 | CON 18 | DES 20 | INT 38 | VON 42 | CAR 16 | XP 430
Behavior CasterSupport | Move CasterKeepAway/FloatingOrbit | Ataques: MoonBolt, DarkZone

 enemy_drow_web_scout | Batedor de Teia Drow
HP 780 | MP 80 | STA 120 | BR 110 | FOR 16 | CON 18 | DES 36 | INT 24 | VON 24 | CAR 8 | XP 360
Behavior Ranged/Controller | Move KiteRanged/PackFlanker | Ataques: WebShotSlow, ShadowArrow

 enemy_void_caster | Conjurador do Vazio
HP 950 | MP 380 | STA 82 | BR 92 | FOR 6 | CON 20 | DES 18 | INT 44 | VON 48 | CAR 4 | XP 520
Behavior AberrantController/Caster | Move CasterKeepAway | Ataques: VoidPulse, GravitySnareSmall

 enemy_abyss_wisp | Fagulha do Abismo
HP 420 | MP 170 | STA 90 | BR 120 | FOR 2 | CON 10 | DES 36 | INT 18 | VON 28 | CAR 0 | XP 240
Behavior Swarm/Caster | Move FloatingOrbit | Ataques: WispBolt, FearFlicker

 enemy_moonless_hound | Cão Sem-Lua
HP 820 | MP 0 | STA 150 | BR 140 | FOR 30 | CON 22 | DES 38 | INT 4 | VON 22 | CAR 0 | XP 310
Behavior Predator/PackHunter | Move Leaper/PackFlanker | Ataques: MoonlessPounce, PackHowl

 enemy_black_lantern_cultist | Cultista da Lanterna Negra
HP 720 | MP 260 | STA 80 | BR 76 | FOR 8 | CON 18 | DES 16 | INT 34 | VON 40 | CAR 14 | XP 340
Behavior CultRitualist/CasterSupport | Move ProtectAnchor/CasterKeepAway | Ataques: BlackLanternFlare, FearGlare

 enemy_oath_eater | Devorador de Juramento
HP 1750 | MP 180 | STA 95 | BR 90 | FOR 36 | CON 44 | DES 8 | INT 18 | VON 48 | CAR 0 | XP 560
Behavior Tank/Elite | Move TankSlowPush | Ataques: OathCrush, VowDrain

 enemy_mind_eater_adult | Devora-Mentes Abissal
HP 1150 | MP 420 | STA 90 | BR 96 | FOR 8 | CON 20 | DES 18 | INT 52 | VON 44 | CAR 6 | XP 620
Behavior AberrantController/Elite | Move CasterKeepAway/PhaseShortBlink | Ataques: PsychicPulse, ConfusionLite, MindSpike

 enemy_eye_tyrant_blackmoon | Tirano Ocular da Lua Negra
HP 4200 | MP 650 | STA 120 | BR 150 | FOR 10 | CON 52 | DES 20 | INT 58 | VON 58 | CAR 8 | XP 1600
Behavior MiniBoss/AberrantController | Move FloatingOrbit/BossArenaControl | Ataques: SlowGaze, FearGlare, ArcanePierce, MoonlessPulse
```

## 19. Níveis 86-99 — Núcleo Corrompido

```text
enemy_corrupt_hulk | Massa Corrompida
HP 2400 | MP 60 | STA 115 | BR 100 | FOR 58 | CON 62 | DES 8 | INT 4 | VON 44 | CAR 0 | XP 720
Behavior Tank/CorruptedFrenzy | Move TankSlowPush/ChargeLine | Ataques: CorruptSmash, GroundRupture

 enemy_ninrorin_broken_oracle | Oráculo Ninrorin Quebrado
HP 1350 | MP 540 | STA 100 | BR 110 | FOR 6 | CON 24 | DES 20 | INT 64 | VON 62 | CAR 10 | XP 760
Behavior Caster/Controller | Move CasterKeepAway/PhaseShortBlink | Ataques: BrokenProphecy, TimeShardSlow

 enemy_corrupted_pseudodragon | Pseudodragão Corrompido
HP 980 | MP 260 | STA 150 | BR 180 | FOR 18 | CON 20 | DES 54 | INT 24 | VON 34 | CAR 8 | XP 620
Behavior Ranged/PackHunter | Move FloatingOrbit/Leaper | Ataques: CorruptSpit, WingDash

 enemy_blackstone_wyvern | Wyvern de Pedra Negra
HP 9500 | MP 260 | STA 220 | BR 260 | FOR 72 | CON 68 | DES 42 | INT 18 | VON 52 | CAR 0 | XP boss/miniboss
Behavior BossMultiPhase/DraconicPredator | Move ChargeLine/Leaper/FloatingOrbit | Ataques: BlackstoneBite, TailSweep, CorruptBreath

 enemy_blackstone_cult_paragon | Paragon da Pedra Negra
HP 1300 | MP 520 | STA 100 | BR 110 | FOR 12 | CON 24 | DES 22 | INT 58 | VON 60 | CAR 18 | XP 680
Behavior CultRitualist/CasterSupport | Move CasterKeepAway | Ataques: BlackstoneSigil, CorruptBolt

 enemy_core_mirror | Reflexo do Núcleo
HP 1100 | MP 400 | STA 130 | BR 130 | FOR 14 | CON 22 | DES 52 | INT 42 | VON 44 | CAR 0 | XP 610
Behavior Phase/Controller | Move PhaseShortBlink | Ataques: MirrorPierce, ReflectionStep

 enemy_mana_warped_beast | Fera Distorcida por Mana
HP 1650 | MP 160 | STA 190 | BR 180 | FOR 52 | CON 38 | DES 52 | INT 6 | VON 36 | CAR 0 | XP 650
Behavior Predator/CorruptedFrenzy | Move Leaper/ChargeLine | Ataques: ManaClaw, WarpedPounce

 enemy_anya_silent_echo | Eco Silencioso de Anya
HP especial | MP especial | STA especial | BR especial | FOR 0 | CON 60 | DES 20 | INT 70 | VON 90 | CAR 0 | XP 0/especial
Behavior LoreGuardian | Move GuardStationary/FloatingSlow | Ataques: repelir, proteger, revelar lore; não farmável

 enemy_beholder_blackstone | Observador Tirano da Pedra Negra
HP 6800 | MP 900 | STA 120 | BR 180 | FOR 8 | CON 64 | DES 22 | INT 76 | VON 74 | CAR 6 | XP 2600
Behavior Boss/AberrantController | Move FloatingOrbit/BossArenaControl | Ataques: BlackstoneBeam, SlowGaze, FearGlare, CorruptionPulse

 enemy_umber_hulk_corebreaker | Titã Escavador Quebra-Núcleo
HP 3200 | MP 0 | STA 220 | BR 190 | FOR 78 | CON 70 | DES 14 | INT 6 | VON 46 | CAR 0 | XP 950
Behavior BurrowPredator/Tank | Move BurrowAmbush/ChargeLine | Ataques: CoreBreakCharge, MandibleCrush

 enemy_core_devourer_slime | Lodo Devorador de Núcleo
HP 3600 | MP 220 | STA 60 | BR 40 | FOR 46 | CON 82 | DES 3 | INT 12 | VON 58 | CAR 0 | XP 880
Behavior Tank/Controller/TreasureTrap | Move TankSlowPush | Ataques: AcidFlood, Engulf, CorruptGelZone
```
...
## 20. Boss gates 15/30/45/60/75/90/100

```text
boss_blackroot_matriarch | Gate 15
HP 1200 | MP 180 | STA 90 | BR 80 | FOR 24 | CON 34 | DES 8 | INT 12 | VON 28 | CAR 0
...
HP 2000 | MP 80 | STA 130 | BR 120 | FOR 38 | CON 44 | DES 12 | INT 18 | VON 34 | CAR 8
...
HP 3300 | MP 80 | STA 170 | BR 160 | FOR 54 | CON 42 | DES 20 | INT 8 | VON 44 | CAR 8
...
HP 5200 | MP 240 | STA 80 | BR 60 | FOR 50 | CON 70 | DES 4 | INT 42 | VON 58 | CAR 0
...
HP 7600 | MP 720 | STA 130 | BR 150 | FOR 12 | CON 34 | DES 34 | INT 62 | VON 72 | CAR 28
...
HP 11000 | MP 320 | STA 240 | BR 300 | FOR 82 | CON 76 | DES 46 | INT 20 | VON 60 | CAR 0
Fase 1: mordida, cauda, reposicionamento.
Fase 2: voo baixo/Investidas e CorruptBreath.
Fase 3: asa danificada, menos mobilidade, golpes mais fortes e telegraph maior.

 boss_core_oathbreaker | Gate 100
HP 17500 | MP 620 | STA 220 | BR 220 | FOR 78 | CON 92 | DES 22 | INT 50 | VON 95 | CAR 0
...
## 21. Bosses do nível 101

```text
boss_blackstone_warden_prime
HP 19000 | MP 700 | STA 220 | BR 220 | FOR 88 | CON 100 | DES 18 | INT 48 | VON 100 | CAR 0
Fases: guardião posicional -> arena com pilares -> núcleo exposto.

 boss_elyndor_oath_construct
HP 21000 | MP 900 | STA 160 | BR 130 | FOR 72 | CON 110 | DES 12 | INT 86 | VON 100 | CAR 0
Fases: protocolo defensivo -> puzzle/vulnerability cycle -> overload.

 boss_nyx_broken_herald
HP 17500 | MP 1200 | STA 180 | BR 210 | FOR 28 | CON 58 | DES 70 | INT 96 | VON 110 | CAR 30
Fases: sombra/caster -> clones/teleporte -> ritual instável.

 boss_draconic_core_remnant
HP 26000 | MP 850 | STA 300 | BR 340 | FOR 120 | CON 110 | DES 55 | INT 48 | VON 90 | CAR 0
Fases: predador terrestre -> respiração corrompida -> núcleo exposto e fúria final.

 boss_anya_bound_echo
HP especial | MP especial | STA especial | BR especial | FOR 0 | CON 120 | DES 30 | INT 140 | VON 180 | CAR 0
...
## 25. Status permitidos na caverna
...
## 26. Poderes de observadores oculares

Poderes próprios de Vaalara:
...
Observadores oculares, mímicos, lodos, devora-mentes, besouros ferrugem, feras distorcidas, urso-coruja, tubarão de pedra e titãs escavadores estão aprovados como arquétipos adaptados.
```
...
```text
Converter atributos reais para EnemyDataSO.
Criar fórmula final de HP/dano/XP baseada em atributos e level.
Validar se XP real casa com curva de progressão do player.
Implementar BehaviorProfile e MovementProfile como dados ou enum.
Implementar fases de boss sem quebrar boss runtime existente.
Garantir safe anchors para Large/Huge/Boss.
Validar performance com packs maiores.
Definir active budget se muitos inimigos materializados simultaneamente pesarem.
Criar LootTableSO por bioma/faction.
Criar BestiaryEntrySO com atributos dominantes e comportamento observado.
