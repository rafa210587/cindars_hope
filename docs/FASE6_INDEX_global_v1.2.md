...
| **CHAR** — Personagem, atributos, skill tree | FASE6_CHAR_backlog.md | ⏳ Esboço abaixo |
| **SAVE** — Sistema de save/load | Dentro do FARM no MVP; separar em backlog próprio pós-MVP | 🔄 Parcial no MVP |
| **CITY** — Cidade, NPCs, comércio | FASE6_CITY_backlog.md | ⏳ Esboço abaixo |
| **CRAFT** — Workshops, receitas | FASE6_CRAFT_backlog.md | ⏳ Esboço abaixo |
| **CAVE** — Caverna procedural | FASE6_CAVE_backlog.md | ⏳ Esboço abaixo |
| **COMBAT** — Sistema de combate | FASE6_COMBAT_backlog.md | ⏳ Esboço abaixo |
| **COMP** — Companions | FASE6_COMP_backlog.md | ⏳ Esboço abaixo |
| **UI** — Interface, HUD, menus | FASE6_UI_backlog.md | ⏳ Esboço abaixo |
