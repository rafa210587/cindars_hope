# Specs Movidas para Implementados

Este arquivo registra specs que foram movidas de `a_implementar/` para `implementados/` após conclusão de implementação.
...
- Implementação completa do código (validada em Tundra build)
- Play Mode testing pendente (humano)
- Gaps deferred para SPEC 17 documentados
...
- Implementação completa do código (validada em Tundra build)
- Play Mode testing pendente (humano)
- Documento atualizado com detalhes de entrega em 2026-05-25
