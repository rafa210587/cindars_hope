...
$inputPaths = @(Get-ChildItem (Join-Path $projectRoot 'Assets/_Game/Scripts') -Filter *.cs -Recurse -File | Where-Object { $_.Name -match 'Farm|WorldTilemapGround|WorldSpriteLibrary|RoofRevealController|TreeNode' })
