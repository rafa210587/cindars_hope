...
namespace CindarsHope.Editor.Art
{
    ...
    public static class FarmAmbientAnimationAuthoring
    {
        ...
        [Serializable] public sealed class ValidationReport
        {
            ...
            public string method = "AnimationClip keyframes and native AnimationClip.SampleAnimation on a temporary Editor object. This is not a 21-second Play Mode observation, performance measurement or visual approval.";
        ...
        public static ValidationReport Apply(Scene scene)
        {
            ...
            var fish = fishTransform.GetComponent<SpriteRenderer>() ?? fishTransform.gameObject.AddComponent<SpriteRenderer>();
            ...
            Vector2 canvas, Vector2 pivot, float ppu, float period)
        {
            ...
            keys.Add(new ObjectReferenceKeyframe { time = period, value = delayed ? null : frames[0] });
            clip.ClearCurves();
        ...
        private static void BindAnimator(SpriteRenderer renderer, AnimationClip clip, string id)
        {
            ...
            var animator = renderer.GetComponent<Animator>() ?? renderer.gameObject.AddComponent<Animator>();
            ...
            foreach (var id in new[] { "fountain_v15", "cascade_v15", "fish_v15" })
            {
                ...
                try
                {
                    ...
                    for (var i = 0; i < curve.Length - 1; i++)
                    {
                        ...
                        clip.SampleAnimation(temp, time);
