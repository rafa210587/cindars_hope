...
> Este arquivo complementa `docs/NEXT_WAVES_ROADMAP_v1.0.md` sem apagar o histórico anterior.
> A fonte detalhada da fase é `docs/FASE9C_TOOLS_FARM_COMBAT_REFINEMENT_v1.0.md`.
