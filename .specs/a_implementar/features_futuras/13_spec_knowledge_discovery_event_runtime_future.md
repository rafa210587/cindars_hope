...
```bash
rg -n "KnowledgeDiscovery|EnemySeen|EnemyDefeated|DamageTypeEffective|DamageTypeResisted|RareDropCollected|ImmunityTriggered|BossPhaseReached|KnowledgeUnlock" Assets/_Game/Scripts docs/design .specs
