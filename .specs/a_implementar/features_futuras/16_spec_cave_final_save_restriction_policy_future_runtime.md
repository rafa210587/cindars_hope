...
```bash
rg -n "CaveSavePolicy|CaveSavePermission|SaveManager|CaveSaveData|Checkpoint|CorpseRecovery|Level101|RewardPending" Assets/_Game/Scripts docs/design .specs
