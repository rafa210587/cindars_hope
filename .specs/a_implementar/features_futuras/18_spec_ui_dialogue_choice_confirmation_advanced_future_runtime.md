...
```bash
rg -n "DialogueChoice|DialogueConfirmation|AcceptQuest|DeliverItem|ConfirmGift|StartRomance|FinalChoice|ActivateFonte|EnterCave" Assets/_Game/Scripts docs/design .specs
