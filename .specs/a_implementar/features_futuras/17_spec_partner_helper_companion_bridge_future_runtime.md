...
```bash
rg -n "PartnerHelper|PartnerCompanion|PartnerFarmHelper|SpouseHelper|Polycule|CompanionEligibility|CaveCompanion|FarmHelperBudget" Assets/_Game/Scripts docs/design .specs
