...
```bash
rg -n "BestiaryEntry|KnowledgeLog|KnownInteraction|KnownDrop|BestiaryTooltip|KnownEffectiveness|Unknown|Silhouette|Spoiler" Assets/_Game/Scripts docs/design .specs
