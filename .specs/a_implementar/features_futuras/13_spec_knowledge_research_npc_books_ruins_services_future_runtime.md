...
```bash
rg -n "ResearchProvider|KnowledgeResearch|Book|Diary|Inscription|Ruin|Corvus|Yael|Sethra|Vaelrion|Rumor|Reliability|Bias" Assets/_Game/Scripts docs/design .specs
