...
```bash
rg -n "FarmAutomationGovernor|AutomationBudget|AutomationActor|PartnerHelper|HiredWorker|NpcHelper|PetBlocked|AutomationPermission" Assets/_Game/Scripts docs/design .specs
