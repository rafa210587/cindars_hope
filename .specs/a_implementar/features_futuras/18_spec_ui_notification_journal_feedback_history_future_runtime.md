...
```bash
rg -n "NotificationHistory|NotificationJournal|NotificationDeduplication|CriticalNotification|FonteReaction|FragmentRecovered|DebugOnly|Journal" Assets/_Game/Scripts docs/design .specs
