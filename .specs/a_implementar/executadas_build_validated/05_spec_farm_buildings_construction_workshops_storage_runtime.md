...
> **Depends on:**  
  ...
  - `.specs/a_implementar/04_spec_ui_storage_chest_transfer_runtime.md`
  - `.specs/a_implementar/04_spec_ui_crafting_screen_runtime.md`
> **Blocks:**  
...
```bash
rg -n "Construction|Building|Workshop|Storage|Demolish|MoveBuilding|ConstructionJob|BuildingInstance|FarmBuilding" Assets/_Game/Scripts docs/design .specs
