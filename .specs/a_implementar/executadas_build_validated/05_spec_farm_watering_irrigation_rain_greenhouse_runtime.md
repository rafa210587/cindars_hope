...
```bash
rg -n "Watering|WaterSource|Rain|Storm|Irrigation|Sprinkler|Greenhouse|IsWatered|FarmPlotWaterState|DayTransition" Assets/_Game/Scripts docs/design .specs
