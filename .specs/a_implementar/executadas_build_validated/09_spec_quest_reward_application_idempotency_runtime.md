...
```bash
rg -n "QuestReward|RewardApplication|GrantedRewardIds|GrantedFlagIds|Gold|Item|Recipe|ShopUnlock|FonteUpgrade|LivingWaterCharge|PetUnlockFuture" Assets/_Game/Scripts docs/design .specs
