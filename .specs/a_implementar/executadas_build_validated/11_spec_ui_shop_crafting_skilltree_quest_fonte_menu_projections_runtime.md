...
```bash
rg -n "ShopMenu|BuySell|CraftingMenu|RecipeProjection|SkillTreeMenu|QuestLogMenu|FonteMenu|MenuCommand|EmptyState" Assets/_Game/Scripts docs/design .specs
