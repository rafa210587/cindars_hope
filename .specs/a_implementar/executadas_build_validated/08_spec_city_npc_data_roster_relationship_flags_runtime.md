...
```bash
rg -n "NpcDefinition|NPCData|FunctionalGameplayClass|RelationshipStatus|RomanceEligible|MarriedToNpc|DeityWorshipped|Folego|Breath|BR|D&D|Cleric|Paladin" Assets/_Game/Scripts docs/design .specs
