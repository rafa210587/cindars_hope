...
```bash
rg -n "MainProgression|MainAct|FragmentState|WaterFragment|MemoryFragment|LifeFragment|HopeFragment|StoryGate|Level100Gate|Level101Access" Assets/_Game/Scripts docs/design .specs
