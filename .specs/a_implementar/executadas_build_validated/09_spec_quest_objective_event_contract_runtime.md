...
```bash
rg -n "QuestDefinition|QuestCategory|QuestState|QuestStep|QuestObjective|ObjectiveType|CompletionMode|QuestEventName|PetFuture|SocialFuture" Assets/_Game/Scripts docs/design .specs
