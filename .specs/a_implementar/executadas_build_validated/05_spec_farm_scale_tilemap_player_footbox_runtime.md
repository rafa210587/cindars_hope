...
```bash
rg -n "FarmScene|Tilemap|Grid|CellSize|Footbox|Collider|SortingY|Pivot|InteractionBox|CameraFollow|CameraBounds" Assets/_Game/Scripts Assets/_Game docs/design .specs
