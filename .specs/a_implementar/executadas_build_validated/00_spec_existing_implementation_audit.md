...
> **Repo lock scope:** `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md`, `.specs/SPEC_REGISTRY_TO_IMPLEMENT.md`, `.specs/SPEC_REGISTRY_IMPLEMENTED.md`, `.specs/SPEC_GENERATION_ROADMAP_MASTER.md`, `docs/IMPLEMENTATION_STATUS.md`, `docs/project/CURRENT_STATE.md` somente para leitura salvo autorização explícita.  
> **Depends on:**  
...
.specs/implementados/** — para validar sistemas já implementados/parciais.
...
- criar `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md`;
...
- Existe `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md`.
...
```bash
rg -n "IMPLEMENTED|PARTIAL|BUILD_VALIDATED|UNITY_VALIDATED|DEFERRED_TO_FINAL_HUMAN_VALIDATION|ACCEPTED|BLOCKED" .specs docs/validation docs/IMPLEMENTATION_STATUS.md docs/project/CURRENT_STATE.md
```
...
Criar `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md` com evidências e recomendações.
...
```text
Remover `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md`.
...
- [ ] T009 — Criar `.specs/SPEC_EXISTING_IMPLEMENTATION_AUDIT.md`.
