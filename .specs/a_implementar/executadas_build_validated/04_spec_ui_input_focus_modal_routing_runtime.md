...
```bash
rg -n "GameplayInputRouter|ModalManager|InputFocus|UIFocus|DialogueFocus|MenuFocus|ShopFocus|InventoryFocus|Pause|Back|Cancel|Confirm" Assets/_Game/Scripts docs/design .specs
