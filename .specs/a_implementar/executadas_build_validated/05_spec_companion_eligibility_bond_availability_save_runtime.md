...
```bash
rg -n "Companion|Eligibility|Bond|Trust|Availability|Injury|Unlock|CanBeFarmCompanion|CanBeCaveCompanion|Pet|Romance" Assets/_Game/Scripts docs/design .specs
