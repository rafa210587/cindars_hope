...
> **Depends on:**  
  ...
  - `.specs/a_implementar/05_spec_farm_building_footprints_placement_grid_runtime.md`
> **Blocks:**  
...
```bash
rg -n "FarmPropertyLevel|ExpansionZone|FarmZone|ZoneType|FreeBuild|LockedZone|BlockedZone|LoreZone|EndgameZone|FarmLevel|BuildingPlacement" Assets/_Game/Scripts Assets/_Game docs/design .specs
...
```bash
rg -n "Farm|FarmScene|Tilemap|Grid|Footbox|Collider|Sorting|Anchor|Building|Footprint|Placement|Expansion|Zone" Assets/_Game/Scripts Assets docs/design .specs
```
