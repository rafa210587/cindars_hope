...
```bash
rg -n "ShopInventory|StockLine|StockType|RestockPolicy|ShopStockState|CurrentQuantity|UniqueStock|LimitedStock|RotatingStock|PlayerSoldStock" Assets/_Game/Scripts docs/design .specs
