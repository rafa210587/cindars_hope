...
```bash
rg -n "Equipment|Equip|Compare|Requirement|Durability|Material|Tier|KnownVulnerability|Bestiary|SpellSource|ActiveSkill|Accessory" Assets/_Game/Scripts docs/design .specs
