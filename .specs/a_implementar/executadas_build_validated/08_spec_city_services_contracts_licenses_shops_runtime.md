...
```bash
rg -n "CityService|ServiceProvider|ServiceAvailability|License|Contract|ShopService|TownHall|TempleBlessing|NightShop|Anya|Kanthor" Assets/_Game/Scripts docs/design .specs
