...
> - `.specs/a_implementar/01_spec_save_provider_architecture_runtime.md`  
> - `.specs/implementados/spec_data_001_ids_registries_e_scriptableobjects.md`  
...
```bash
rg -n "StableId|Registry|ItemId|CropId|QuestId|InvalidId|Fallback|Save|GameSaveData|Migration" Assets/_Game/Scripts docs/design .specs
