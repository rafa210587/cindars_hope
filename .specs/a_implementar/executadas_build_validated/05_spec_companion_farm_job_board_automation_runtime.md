...
```bash
rg -n "CompanionJob|JobBoard|FarmJob|AllowedArea|AllowedResource|OutputDestination|Plantador|Regador|Colhedor|Tratador|Pet" Assets/_Game/Scripts docs/design .specs
