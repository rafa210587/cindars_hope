...
```bash
rg -n "FestivalQuest|FestivalExpiry|CaveContract|DefeatEnemyFamily|ReachCaveDepth|DiscoverWeakness|ContractReward|RepeatPolicy|CaveRunSeed" Assets/_Game/Scripts docs/design .specs
