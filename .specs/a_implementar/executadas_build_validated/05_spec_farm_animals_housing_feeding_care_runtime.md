...
> **Depends on:**  
  ...
  - `.specs/a_implementar/05_spec_farm_buildings_construction_workshops_storage_runtime.md`
...
```bash
rg -n "Animal|FarmAnimal|Livestock|Cow|Chicken|Sheep|Feed|FedToday|CareScore|HomeBuilding|Barn|Coop|Pasture" Assets/_Game/Scripts docs/design .specs
