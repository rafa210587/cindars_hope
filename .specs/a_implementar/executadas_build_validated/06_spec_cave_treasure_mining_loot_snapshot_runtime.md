...
```bash
rg -n "CaveLoot|MiningNode|TreasureChest|CaveSnapshot|VisitedLevelSnapshot|DepletedNodeIds|ResourceNode|LootRollSeed|CaveRunSeed|Level101" Assets/_Game/Scripts docs/design .specs
