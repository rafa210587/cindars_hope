...
- .specs/SPEC_GENERATION_ROADMAP_TESTING_QUALITY_GATE_ADDENDUM.md
- .specs/a_implementar/spec_test_harness_editmode_playmode_quality_gate.md
...
rg -n "DEFERRED_TO_FINAL_HUMAN_VALIDATION|PlayMode|FINAL_HUMAN_VALIDATION_BY_WAVE|human test|docs/05_VALIDATION" .claude docs/validation .specs CLAUDE.md AGENTS.md
```
...
```bash
rg -n "EditMode|PlayMode|QualityGate|Testing Quality Gate|BUILD_VALIDATED|PARTIAL|ACCEPTED|Final Human" Assets/_Game/Scripts docs/design .specs
...
```bash
rg -n "docs/05_VALIDATION|human test por spec|Play Mode humano obrigatório por spec" CLAUDE.md AGENTS.md .claude .specs docs/validation
rg -n "DEFERRED_TO_FINAL_HUMAN_VALIDATION|FINAL_HUMAN_VALIDATION_BY_WAVE|SPEC_VALIDATION_MATRIX_MASTER" CLAUDE.md .claude .specs docs/validation
```
