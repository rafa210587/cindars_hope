...
```bash
rg -n "BuildingId|FootprintTiles|FootprintPx|EntranceTiles|RequiredClearance|CanMove|CanRotate|BlocksPath|ValidTerrainTags|RequiredFarmLevel|PlacementValidator" Assets/_Game/Scripts Assets/_Game docs/design .specs
