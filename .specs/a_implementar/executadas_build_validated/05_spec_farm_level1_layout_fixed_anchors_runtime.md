...
```bash
rg -n "FarmLevel|FarmAnchor|Fonte|Fountain|Lake|CaveEntrance|CityExit|SellPoint|FarmHouse|InitialField|ExpansionZone|FixedTile|FreeTile" Assets/_Game/Scripts Assets/_Game docs/design .specs
