...
```bash
rg -n "Inventory|ItemStack|ItemInstance|ItemDetail|Tooltip|CanSell|CanDiscard|QuestItem|KeyItem|Favorite|Equipped|UseItem|SplitStack" Assets/_Game/Scripts docs/design .specs
