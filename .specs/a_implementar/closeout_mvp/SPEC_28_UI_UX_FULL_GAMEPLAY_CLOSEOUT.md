...
Fechar a spec ativa `.specs/a_implementar/spec_ui_ux_full_gameplay_inventory_hotbar_menus.md` sem criar gameplay novo.
...
```text
.specs/a_implementar/spec_ui_ux_full_gameplay_inventory_hotbar_menus.md
