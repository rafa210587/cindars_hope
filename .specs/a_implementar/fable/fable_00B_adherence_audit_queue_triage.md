...
## 3. Triagem da fila `.specs/a_implementar/` (nível raiz)
...
`.specs/a_implementar/executadas_build_validated/` com README explicando o estado.
...
- .specs/a_implementar/executadas_build_validated/FIX_001_runtime_warnings_town_shop_catalog_alignment.md
