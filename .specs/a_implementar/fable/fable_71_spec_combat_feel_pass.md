...
nenhum arquivo `.cs`; só aparece em .specs. Sem ele, a F43 não tem contrato para suprimir
...
.specs/a_implementar/fable/fable_43_spec_endgame_act5_final_bosses_choice.md (consumidora do HudSuppressionChangedEvent — não recriar números de dano)
...
- HudSuppressionChangedEvent (só citado em .specs; sem definição .cs em runtime).
