...
(spec_retro_01..09 em .specs/implementados/ — documentam código que existia SEM spec:
...
R01..R09 = spec_retro_01..09 em .specs/implementados/ (espelho em
...
Em `.specs/a_implementar/features_futuras/` (NÃO entram na enumeração Exx do lote v1):
