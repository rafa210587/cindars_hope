...
> **Local das specs:** `.specs/a_implementar/fable/` — fora da fila executável automática
...
2. Mover `fable_NN_spec_*.md` para `.specs/a_implementar/` renomeando para `spec_fable_NN_*.md`
