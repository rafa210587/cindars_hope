...
```bash
rg -n "CaveWeatherModifier|CaveLunarModifier|CaveRiskReward|Alihana|Senya|Nyx|Storm|Fog|BlackStone|SnapshotPolicy" Assets/_Game/Scripts docs/design .specs
