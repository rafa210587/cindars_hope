...
```bash
rg -n "ResearchService|KnowledgeResearch|ResearchProvider|Laboratory|ResearchUnlock|ResearchBias|Corvus|Yael|Sethra|Vaelrion" Assets/_Game/Scripts docs/design .specs
