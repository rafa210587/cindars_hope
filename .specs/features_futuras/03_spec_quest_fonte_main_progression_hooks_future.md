...
```bash
rg -n "Fonte|Anya|MainProgression|Fragment|LivingWater|Respec|Purification|FinalChoice|Quest|Reward" Assets/_Game/Scripts docs/design .specs
...
```bash
rg -n "Quest|Objective|Condition|Trigger|Reward|Flag|FarmOrder|Festival|Bestiary|Fonte|MainProgression" Assets/_Game/Scripts docs/design .specs
```
