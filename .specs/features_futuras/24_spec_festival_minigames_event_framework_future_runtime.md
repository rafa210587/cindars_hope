...
```bash
rg -n "Festival|Minigame|FestivalReward|FestivalSchedule|FestivalScoring|HarvestFestival|MemoryFestival|ProtectionFestival|SecretFestival" Assets/_Game/Scripts docs/design .specs
