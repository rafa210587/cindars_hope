...
> **Depends on:**  
  ...
  - `.specs/a_implementar/03_spec_quest_state_save_load_runtime.md`
...
```bash
rg -n "Softlock|QuestDefinition|Critical|MainQuest|Fallback|Recovery|QuestItem|KeyItem|NPC|Weather|Lunar|Death|Corpse|Save" Assets/_Game/Scripts docs/design .specs
