...
> **Local:** `.specs/SPEC_WAVE_EXECUTION_PROTOCOL.md`  
...
```text
Criar contrato implementável em .specs/a_implementar/.
Não alterar runtime.
...
SPEC_CREATED
  Arquivo existe em .specs/a_implementar/.
...
4. Confirmar que specs da wave existem em .specs/a_implementar/.
...
```text
uma spec concreta nova é criada em .specs/a_implementar/;
