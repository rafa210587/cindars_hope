...
- .specs/a_implementar/spec_ui_menu_systems_final.md
...
Cindar's Hope usa Unity, C#, pixel art 2D e fluxo SpecKit. A partir da reconciliacao documental, esta spec vive somente em `.specs/a_implementar/` e substitui qualquer equivalente que existia em `specs/`.
