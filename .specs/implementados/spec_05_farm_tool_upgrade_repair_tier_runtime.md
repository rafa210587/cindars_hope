...
> **Depends on:**  
  ...
  - `.specs/a_implementar/04_spec_ui_repair_upgrade_screen_flow_runtime.md`
  - `.specs/a_implementar/05_spec_farm_trees_wood_stumps_regrowth_runtime.md`
  - `.specs/a_implementar/05_spec_farm_rocks_stone_light_mining_runtime.md`
> **Blocks:**  
  - tool actions;
  - repair/upgrade UI;
...
```bash
rg -n "Tool|FarmTool|Hoe|AxeTool|Pickaxe|WateringCan|FishingRod|ToolUpgrade|ToolTier|Repair|Durability" Assets/_Game/Scripts docs/design .specs
