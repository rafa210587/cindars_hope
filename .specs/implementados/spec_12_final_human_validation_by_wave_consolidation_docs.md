...
```bash
rg -n "FINAL_HUMAN_VALIDATION|DEFERRED_TO_FINAL_HUMAN_VALIDATION|PLAYMODE_VALIDATED|ACCEPTED|human scenario|PlayMode|Unity" .specs docs/validation .claude/rules .claude/skills CLAUDE.md
