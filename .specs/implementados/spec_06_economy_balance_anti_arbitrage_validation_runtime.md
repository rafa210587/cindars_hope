...
```bash
rg -n "EconomyBalance|AntiArbitrage|GoldHour|BuySell|RestockExploit|ProcessingLoop|ProtectedItem|UniqueStock|BossReward" Assets/_Game/Scripts docs/design .specs
