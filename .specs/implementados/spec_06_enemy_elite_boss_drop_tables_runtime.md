...
```bash
rg -n "EnemyDrop|EnemyDropProfile|EliteDrop|BossReward|BossDefeatState|FirstTimeReward|RepeatReward|XPReward|NoNormalLoot" Assets/_Game/Scripts docs/design .specs
