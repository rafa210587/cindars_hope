...
```bash
rg -n "SellPoint|Shipping|PendingShipping|ShippingPrice|GoldChanged|Deposit|NonSellable|QuestItem|KeyItem|ProcessedPayment|DayTransition" Assets/_Game/Scripts docs/design .specs
