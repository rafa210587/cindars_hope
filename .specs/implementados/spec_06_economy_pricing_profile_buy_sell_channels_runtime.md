...
```bash
rg -n "PricingProfile|PriceChannel|PriceRequest|SellPrice|BuyPrice|ShippingPrice|ShopBuyFromPlayerPrice|ShopSellToPlayerPrice|AntiArbitrage" Assets/_Game/Scripts docs/design .specs
