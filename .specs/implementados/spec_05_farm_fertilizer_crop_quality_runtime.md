...
> **Depends on:**  
  ...
  - `.specs/a_implementar/05_spec_farm_soil_crop_growth_quality_runtime.md`
...
```bash
rg -n "Fertilizer|SoilModifier|CropQuality|QualityResolver|FertilizerApplied|Lunar|Arcane|LivingWater" Assets/_Game/Scripts docs/design .specs
