# SPEC FARM-002 - Plots, seeds, growth e harvest

> Status: Implementado parcial
> Camada: Farm
> Fonte historica: `docs_old/FASE7_SPEC_MVP_FARM_v2.2.md`
> Evidencia principal: `Assets/_Game/Scripts/Farm/**`
...
### O que existe
Plots permitem plantar seeds, avancar dias, crescer crops e colher no MVP.
...
### Pendente/futuro
- [ ] Irrigacao, solo avancado, UX final e migracoes de seed futuras pendentes.
...
|---|---|---|
| Codigo | `Assets/_Game/Scripts/Farm/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Data/Seeds/**` | Evidencia principal da capacidade. |
| Codigo | `Assets/_Game/Scripts/Save/FarmSaveData.cs` | Evidencia principal da capacidade. |
