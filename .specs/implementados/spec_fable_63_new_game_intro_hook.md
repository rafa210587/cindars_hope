...
```text
.specs/a_implementar/fable/fable_10_spec_main_quest_act1_playable_runtime.md
  (IDs mq_act1_01..05, Corvus/Thalindra/Maelor, PrerequisiteQuestIds, OfferQuest)
.specs/a_implementar/fable/fable_34_spec_quest_sources_infrastructure.md
  (QuestSource.Main; fluxo único de aceite)
.specs/a_implementar/fable/fable_56_spec_system_tab_title_flow.md (New Game/reset)
