...
.specs/a_implementar/fable/fable_35_spec_npc_side_quest_chains.md (consumidora — texto novo de side quest P4)
.specs/a_implementar/fable/fable_36_spec_main_quest_acts_2_4.md (consumidora — texto novo de quest principal)
.specs/a_implementar/fable/fable_70_spec_npc_side_quest_chains_wave2.md (consumidora — segunda onda de side quests)
.specs/a_implementar/fable/fable_67_spec_canonical_governance_input_map_adr.md (convenção canônica de id/texto coordenada com F67)
